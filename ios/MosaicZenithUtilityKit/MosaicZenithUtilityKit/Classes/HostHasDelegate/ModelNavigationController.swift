...
class ModelNavigationController: UINavigationController {

    //: var tabBarType: TabBarItemType?
    var tabBarType: EleventhHourColumnConvertible?
    //: var pushing = false                             
    ...
    override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        if viewControllers.count >= 1 {
            ...
            if viewController.navigationItem.leftBarButtonItem == nil {
                ...
                viewController.navigationItem.leftBarButtonItem = viewController.origin()
            }
        }
    ...
    func prompt() {
        ...
        if #available(iOS 15.0, *) {
            ...
            barApp.backgroundImage = UIImage.equalImaginationImage(color: UIColor.white)
            //: barApp.shadowImage = UIImage.init()
            barApp.shadowImage = UIImage.init()
            //: barApp.shadowColor = UIColor.appBgColor()
            barApp.shadowColor = UIColor.addChoice()
            ...
            barApp.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.equalTarget(), NSAttributedString.Key.font: UIFont.font(type: .Medium, fontSize: 17)]
        ...
        //: } else {
            ...
            navigationBar.setBackgroundImage(UIImage.equalImaginationImage(color: UIColor.white), for: .any, barMetrics: .default)
            ...
            navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.equalTarget(), NSAttributedString.Key.font: UIFont.font(type: .Medium, fontSize: 17)]
        }
        //: UINavigationBar.appearance().tintColor = UIColor.appTitleColor()
        UINavigationBar.appearance().tintColor = UIColor.equalTarget()
...
extension ModelNavigationController: UINavigationControllerDelegate {
...
extension ModelNavigationController: UIGestureRecognizerDelegate {

...
fileprivate let main_viewTitle:[UInt8] = [0x5c,0x5b,0x5c,0x41,0x1d,0x56,0x5a,0x51,0x50,0x47,0xf,0x1c,0x15,0x5d,0x54,0x46,0x15,0x5b,0x5a,0x41,0x15,0x57,0x50,0x50,0x5b,0x15,0x5c,0x58,0x45,0x59,0x50,0x58,0x50,0x5b,0x41,0x50,0x51]

				private func thinValue(edge num: UInt8) -> UInt8 {
					return num ^ 53
				}

/*: "img_match_shadow" :*/
fileprivate let dataLeadingKey:[Character] = ["i","m","g","_","m"]
fileprivate let mainManagerText:[Character] = ["a","t","c","h","_","s","h","a","d","o","w"]

/*: "icon_match_topshowdown" :*/
fileprivate let data_transformTitle:[Character] = ["i","c","o","n","_","m","a"]
fileprivate let mainBlueName:[Character] = ["t","c","h","_","t","o","p","s","h"]
fileprivate let app_writePopPath:String = "osuccessdosuccessn"

/*: "Matching..." :*/
fileprivate let userImageValue:String = "Matcell top element product let"
fileprivate let const_modelPath:[Character] = ["c","h","i","n","g",".",".","."]

/*: "get json error" :*/
fileprivate let kLiveName:String = "area showget js"
fileprivate let app_textValue:[Character] = ["o","r"]

/*: "img_home_shadow" :*/
fileprivate let notiClearFormat:String = "face viewimg_"
fileprivate let userInsideMessage:String = "SHADOW"

/*: "icon_home_girl" :*/
fileprivate let mainLabelPathStr:[Character] = ["i","c","o","n"]
fileprivate let k_viewAngleTagId:String = "progress temp_home"
...
typealias TouchCallBlock = (_ model: SkipMeasurable) -> Void

//: class TalkingClubCardItemCell: TalkingClubCardViewCell {
class CompartmentViewCell: WaitView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_viewTitle.map{thinValue(edge: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var gradientShadowImageView: UIImageView = {
        ...
        imageView.image = UIImage.snapIcon(name: (String(dataLeadingKey) + String(mainManagerText)))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var topShowdImageView: UIImageView = {
        ...
        imageView.image = UIImage.snapIcon(name: (String(data_transformTitle) + String(mainBlueName) + app_writePopPath.replacingOccurrences(of: "success", with: "w")))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var sexBtn: UIButton = {
        ...
        btn.titleLabel?.font = .font(type: .Medium, fontSize: 13)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var matchTipsLabel: UILabel = {
        ...
        label.text = (String(userImageValue.prefix(3)) + String(const_modelPath)).localized
        //: label.isHidden = true
        label.isHidden = true
        //: return label
        return label
    ...
    lazy var callPlayer: SVGAPlayer = {
        ...
        let url = ValueReactiveCompatible.default.express(type: .Match_userCall)
        //: do {
        do {
            ...
            printLog(message: (String(kLiveName.suffix(6)) + "on err" + String(app_textValue)))
        }
        //: return player
        return player
        //: }()
...
extension CompartmentViewCell {
    ...
    func successfully(model: SkipMeasurable) {
        //: self.model = model
        self.model = model
        ...
        if model.cover.count > 0 {
            ...
            userImageView.applicatorEqual(urlStr: model.cover, placeImg: UIImage.snapIcon(name: (String(notiClearFormat.suffix(4)) + "home_" + userInsideMessage.lowercased())))
            ...
            userImageView.applicatorEqual(urlStr: model.headPic, placeImg: UIImage.snapIcon(name: (String(notiClearFormat.suffix(4)) + "home_" + userInsideMessage.lowercased())))
            //: } else {
        } else {
            //: userImageView.image = UIImage.BundleImageNamed(name: "img_home_shadow")
            userImageView.image = UIImage.snapIcon(name: (String(notiClearFormat.suffix(4)) + "home_" + userInsideMessage.lowercased()))
        }
        //: userIconImg.setUrlImage(urlStr: model.headPic, placeImg: nil)
        userIconImg.inclose(urlStr: model.headPic, placeImg: nil)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
        sexBtn.setBackgroundImage(UIImage.snapIcon(name: (String(mainLabelPathStr) + String(k_viewAngleTagId.suffix(5)) + "_girl")), for: .normal)

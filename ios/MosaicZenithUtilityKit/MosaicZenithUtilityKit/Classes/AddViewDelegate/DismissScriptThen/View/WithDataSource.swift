...
fileprivate let user_kindStr:[UInt8] = [0xab,0xb0,0xab,0xb6,0x6a,0xa5,0xb1,0xa6,0xa7,0xb4,0x7c,0x6b,0x62,0xaa,0xa3,0xb5,0x62,0xb0,0xb1,0xb6,0x62,0xa4,0xa7,0xa7,0xb0,0x62,0xab,0xaf,0xb2,0xae,0xa7,0xaf,0xa7,0xb0,0xb6,0xa7,0xa6]

				fileprivate func nameFailPic(info num: UInt8) -> UInt8 {
...
/*: "JXBannerCellID" :*/
fileprivate let dataMixtureText:String = "self if modelJXBan"
fileprivate let noti_fileMsg:String = "ellIDitem shared data device"
...
class WithDataSource: UITableViewCell {
    //: private var adBannderListData = [SocialAdBannerModel]()
    private var adBannderListData = [LiveTransformable]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_kindStr.map{nameFailPic(info: $0)}, encoding: .utf8)!)
    }
...
extension WithDataSource: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(dataMixtureText.suffix(5)) + "nerC" + String(noti_fileMsg.prefix(5))))
    }
...
extension WithDataSource {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func clickBegin(bannerData: [LiveTransformable]) {

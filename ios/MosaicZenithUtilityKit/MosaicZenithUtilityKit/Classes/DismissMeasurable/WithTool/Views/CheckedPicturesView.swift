...
fileprivate let mainAngleId:[UInt8] = [0xcc,0xcb,0xcc,0xd1,0x8d,0xc6,0xca,0xc1,0xc0,0xd7,0x9f,0x8c,0x85,0xcd,0xc4,0xd6,0x85,0xcb,0xca,0xd1,0x85,0xc7,0xc0,0xc0,0xcb,0x85,0xcc,0xc8,0xd5,0xc9,0xc0,0xc8,0xc0,0xcb,0xd1,0xc0,0xc1]

/*: "img_match_shadow" :*/
fileprivate let kIndexText:[Character] = ["i","m","g","_","m","a","t","c","h"]
fileprivate let main_screenRootStr:String = "user no_shadow"

/*: "icon_home_girl" :*/
fileprivate let noti_sizeKey:String = "icon_name frame"
fileprivate let notiEqualSharedViewData:String = "girmake"

/*: "icon_home_v" :*/
fileprivate let notiShareReportStr:String = "view super makeicon_h"
fileprivate let user_sizeKey:[Character] = ["o","m","e","_","v"]

/*: "btn_dynamic_stop_nor" :*/
fileprivate let appAddItemCaseValue:String = "mode status info livebtn_d"
fileprivate let kEqualMsg:String = "cell at falseic_stop"
fileprivate let dataAppStr:String = "icon as dark_nor"

/*: "#2DF2FF" :*/
fileprivate let main_labMessage:String = "#show"
fileprivate let dataPhotoUrl:[Character] = ["D","F","2","F","F"]

/*: "img_home_shadow" :*/
fileprivate let const_arrayMsg:[Character] = ["i","m","g","_","h","o"]
fileprivate let data_sharedFormat:[Character] = ["m","e","_","s","h","a","d","o","w"]

/*: "icon_home_boy" :*/
fileprivate let appEventEffectStr:String = "ICON"
fileprivate let main_agentStr:String = "_home_boybeauty year extension text"

/*: "LiveReactiveCompatible" :*/
fileprivate let dataModelPath:String = "of var policy itemTUser"
fileprivate let dataFileValue:String = "Headeif text make class photo"
fileprivate let show_sizePath:String = "pop"

/*: "#FFFFFF" :*/
fileprivate let dataQuantityId:String = "#FFFFFFof image"
...
class CheckedPicturesView: UIView {
    ...
    private var model = SkipMeasurable()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainAngleId.map{$0^165}, encoding: .utf8)!)
    }
    ...
    lazy var gradientShadowImageView: UIImageView = {
        ...
        imageView.image = UIImage.snapIcon(name: (String(kIndexText) + String(main_screenRootStr.suffix(7))))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var sexImgV: UIImageView = {
        ...
        img.image = UIImage.snapIcon(name: (String(noti_sizeKey.prefix(5)) + "home_" + notiEqualSharedViewData.replacingOccurrences(of: "make", with: "l")))
    ...
    private lazy var authImgV: UIImageView = {
        ...
        img.image = UIImage.snapIcon(name: (String(notiShareReportStr.suffix(6)) + String(user_sizeKey)))
        //: img.isUserInteractionEnabled = true
        img.isUserInteractionEnabled = true
        //: return img
        return img
    ...
    lazy var playImageView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.snapIcon(name: (String(appAddItemCaseValue.suffix(5)) + "ynam" + String(kEqualMsg.suffix(7)) + String(dataAppStr.suffix(4)))))
        //: imag.isHidden = true
        imag.isHidden = true
        //: return imag
        return imag
...
//        v.roundBgColor = UIColor.white
        ...
        v.progressColor = UIColor(hex: (main_labMessage.replacingOccurrences(of: "show", with: "2") + String(dataPhotoUrl)))!
        //: return v
        return v
        //: }()
    }()
...
extension CheckedPicturesView {
    /// 更新视图UI
    /// - Parameter model: 数据模型
    //: func updatePicturesView(model: TalkingMatchResultModel) {
    func listModel(model: SkipMeasurable) {
        //: self.model = model
        self.model = model
        ...
        userImg.applicatorEqual(urlStr: model.headPic, placeImg: UIImage.snapIcon(name: (String(const_arrayMsg) + String(data_sharedFormat))))
        //: if model.sex == Gender.male.rawValue {
        if model.sex == CommentRefCompatibleValue.male.rawValue {
            //: sexImgV.image = UIImage.BundleImageNamed(name: "icon_home_boy")
            sexImgV.image = UIImage.snapIcon(name: (appEventEffectStr.lowercased() + String(main_agentStr.prefix(9))))
            //: } else {
        } else {
            //: sexImgV.image = UIImage.BundleImageNamed(name: "icon_home_girl")
            sexImgV.image = UIImage.snapIcon(name: (String(noti_sizeKey.prefix(5)) + "home_" + notiEqualSharedViewData.replacingOccurrences(of: "make", with: "l")))
        }
        ...
        self.countdownTimer = Timer.scheduledTimer(withTimeInterval: 0.1, block: { [weak self] _ in
            ...
            self.progressView.plot(totalTime: self.MatchResultProgress_Timer, currTime: time)
            //: time -= 1
            time -= 1
            //: }, repeats: true)
        }, repeats: true)
...
extension CheckedPicturesView: JXBannerDataSource {
    ...
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        ...
        return JXBannerCellRegister(type: LiveReactiveCompatible.self, reuseIdentifier: (String(dataModelPath.suffix(5)) + "Detail" + String(dataFileValue.prefix(5)) + "rItemCe" + show_sizePath.replacingOccurrences(of: "pop", with: "ll")))
    }
    ...
    func jxBanner(_: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
        ...
        if index == 0 && self.model.videoUrl.count > 1 { // 视频
            ...
            bannerCell.capacity(videoUrl: self.model.videoUrl, imgUrl: self.model.cover)
            /// 自动播放完视频后滑动到下一个
...
//                }
            ...
            bannerCell.bgImgView.applicatorEqual(urlStr: str, placeImg: UIImage.withBanner())
        }
    ...
    func jxBanner(pageControl _: JXBannerType, numberOfPages _: Int, coverView: UIView, builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder {
        ...
        pageControl.activeColor = UIColor(hex: (String(dataQuantityId.prefix(7))))!.withAlphaComponent(1.0)
        //: pageControl.inactiveColor = UIColor(hex: "#FFFFFF")!.withAlphaComponent(0.6)
        pageControl.inactiveColor = UIColor(hex: (String(dataQuantityId.prefix(7))))!.withAlphaComponent(0.6)
...
extension CheckedPicturesView: JXBannerDelegate {
...
extension CheckedPicturesView {
    ...
    private func equalColorSubviews() {

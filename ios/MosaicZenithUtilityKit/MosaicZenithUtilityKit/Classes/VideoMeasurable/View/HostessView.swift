...
fileprivate let appRangeViewName:[UInt8] = [0x15,0x1a,0x15,0x20,0xd4,0xf,0x1b,0x10,0x11,0x1e,0xe6,0xd5,0xcc,0x14,0xd,0x1f,0xcc,0x1a,0x1b,0x20,0xcc,0xe,0x11,0x11,0x1a,0xcc,0x15,0x19,0x1c,0x18,0x11,0x19,0x11,0x1a,0x20,0x11,0x10]

				fileprivate func emptyStyleData(temp num: UInt8) -> UInt8 {
...
/*: "icon_home_boy" :*/
fileprivate let k_colorCurrentStr:String = "snap leticon_ho"
fileprivate let noti_remarkStr:[Character] = ["m","e","_","b","o","y"]

/*: "icon_home_girl" :*/
fileprivate let userCloudStr:String = "ICON"
fileprivate let k_insideValueName:String = "e_girlenable function time"
...
class HostessView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appRangeViewName.map{emptyStyleData(temp: $0)}, encoding: .utf8)!)
    }
...
extension HostessView {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func addType(model: VoiceMeasurable, type: ListTableConvertible) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.snapIcon(name: (String(k_colorCurrentStr.suffix(7)) + String(noti_remarkStr))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.snapIcon(name: (userCloudStr.lowercased() + "_hom" + String(k_insideValueName.prefix(6)))), for: .normal)
        //: break
        //: default:
        default:
            //: break

...
fileprivate let main_imagePath:[UInt8] = [0x72,0x75,0x72,0x6f,0x33,0x78,0x74,0x7f,0x7e,0x69,0x21,0x32,0x3b,0x73,0x7a,0x68,0x3b,0x75,0x74,0x6f,0x3b,0x79,0x7e,0x7e,0x75,0x3b,0x72,0x76,0x6b,0x77,0x7e,0x76,0x7e,0x75,0x6f,0x7e,0x7f]

				private func makePlayer(key num: UInt8) -> UInt8 {
					return num ^ 27
				}

/*: "SHBDropMenuCell" :*/
fileprivate let k_viewMessage:[Character] = ["S","H","B","D","r","o","p","M","e","n"]
fileprivate let app_cameraText:[Character] = ["u","C","e","l","l"]
...
public class NameView: UIView {
    ...
    var menuDelegate: WithViewDelegate?
    ...
    var menuBgColor: UIColor? {
        ...
        //: }
    } // = Config.FuturismConfig.menuBgColor
    // 线条颜色
    //: var lineColor = Config.MenuCellConfig.lineColor
    var lineColor = Config.LoadConfig.lineColor
    // cell高度
    //: public var menuCellHeight = Config.MenuCellConfig.menuCellHeight
    public var menuCellHeight = Config.LoadConfig.menuCellHeight
    /**
     *  table最大高度限制
     *  默认：5 * cellHeight
     */
    //: var menuMaxHeight = Config.MenuCellConfig.menuMaxHeight
    var menuMaxHeight = Config.LoadConfig.menuMaxHeight
    /**
     *  小三角高度
     *  45°等腰三角形
     */
    ...
    public var menuStyle = Config.initialMenuStyle ?? AlongMenuStyle.MenuDarkStyle {
        //: didSet {
        didSet {
            //: switch menuStyle {
            switch menuStyle {
...
//        menuView.refreshUI()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_imagePath.map{makePlayer(key: $0)}, encoding: .utf8)!)
    }

    //: private func makeContentView() -> UIView {
    private func blockFocus() -> UIView {
        //: let view  = UIView()
        let view = UIView()
        //: return view
        return view
    ...
    private func labelShared() -> UITableView {
    ...
    private func year() {
        ...
        mTable.register(SongViewCell.self, forCellReuseIdentifier: (String(k_viewMessage) + String(app_cameraText)))
        //: contentView.addSubview(mTable)
        contentView.addSubview(mTable)
    }

    //: private func refreshUI() {
    private func fillGiftTo() {
        //: drawmTableFrame()
        imageActionEyeglassesFrame()
        //: mTable.reloadData()
        mTable.reloadData()
    }
    ...
    private func imageActionEyeglassesFrame() {
...
extension NameView: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: (String(k_viewMessage) + String(app_cameraText)), for: indexPath) as! SongViewCell
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        menuDelegate?.selected(index: indexPath.row, title: cellModel.title ?? "")
    }
}

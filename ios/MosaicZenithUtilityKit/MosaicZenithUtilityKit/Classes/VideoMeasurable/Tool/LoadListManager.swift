...
/*: "blockList_ :*/
fileprivate let main_startMakeData:[Character] = ["b","l","o","c","k","L","i","s","t","_"]
...
class LoadListManager: NSObject {
    ...
    func actionQuantity(userId: String) -> Bool {
    ...
    private func ambages() -> String {
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(main_startMakeData)) + "\(uid)")
        //: return filePath
        return filePath
    }
}

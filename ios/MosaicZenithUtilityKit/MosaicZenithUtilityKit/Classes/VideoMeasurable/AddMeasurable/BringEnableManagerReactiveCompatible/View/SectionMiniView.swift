...
fileprivate let const_pinErrModelKey:[UInt8] = [0xb9,0xbe,0xb9,0xa4,0xf8,0xb3,0xbf,0xb4,0xb5,0xa2,0xea,0xf9,0xf0,0xb8,0xb1,0xa3,0xf0,0xbe,0xbf,0xa4,0xf0,0xb2,0xb5,0xb5,0xbe,0xf0,0xb9,0xbd,0xa0,0xbc,0xb5,0xbd,0xb5,0xbe,0xa4,0xb5,0xb4]

				private func aftBlock(data num: UInt8) -> UInt8 {
					return num ^ 208
				}

/*: "icon_mini_voice_end" :*/
fileprivate let main_topContent:[Character] = ["i","c","o"]
fileprivate let notiBurnStr:String = "color video videon_mini"
fileprivate let appEqualTitle:String = "input title toe_end"

/*: "#F95151" :*/
fileprivate let main_regularName:[Character] = ["#","F","9","5","1","5"]
fileprivate let user_rowMessage:String = "1"

/*: "End of call" :*/
fileprivate let dataAdGiftKey:String = "End ofmodel text app"

/*: "img_home_shadow_icon" :*/
fileprivate let user_makeFormat:[Character] = ["i","m","g","_","h","o","m","e","_","s","h","a","d","o","w","_","i"]
fileprivate let data_tapPath:String = "cselected"
...
class SectionMiniView: EliteReactiveCompatible {
    // 小窗口通话状态
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_pinErrModelKey.map{aftBlock(data: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var renderView: UIView = { // 视频渲染视图
        ...
        view.backgroundColor = .equalTarget()
        //: view.layer.cornerRadius = 8
        view.layer.cornerRadius = 8
        //: view.layer.masksToBounds = true
        view.layer.masksToBounds = true
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.snapIcon(name: (String(main_topContent) + String(notiBurnStr.suffix(6)) + "_voic" + String(appEqualTitle.suffix(5))))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(main_regularName) + user_rowMessage.capitalized))
        //: lab.font = .pingfangFont(type: .Medium, fontSize: 10)
        lab.font = .font(type: .Medium, fontSize: 10)
        //: lab.textAlignment = .center
        lab.textAlignment = .center
        //: lab.text = "End of call".localized
        lab.text = (String(dataAdGiftKey.prefix(6)) + " call").localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.snapIcon(name: (String(user_makeFormat) + data_tapPath.replacingOccurrences(of: "selected", with: "on")))
...
extension SectionMiniView {
    /// 构建视频小窗口
    //: static func buildVideoMiniView() -> TalkingVideoMiniView {
    static func exceptVisualCommunication() -> SectionMiniView {
        //: let view = TalkingVideoMiniView(frame: .zero)
        let view = SectionMiniView(frame: .zero)

...
fileprivate let showTouchValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let notiAcrossData:String = "ICON"
fileprivate let data_appText:String = "dismiss of user to_warn"
...
// __CLOSE_PRINT__
//
//  LimitedMessageReactiveCompatible.swift
//  AbroadTalking
//
...
class LimitedMessageReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showTouchValue.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.snapIcon(name: (notiAcrossData.lowercased() + "_livetc" + String(data_appText.suffix(5))))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = ExamineedReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        lab.text = ExamineedReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(appEvent), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension LimitedMessageReactiveCompatible {
    //: func show() {
    func cellSex() {

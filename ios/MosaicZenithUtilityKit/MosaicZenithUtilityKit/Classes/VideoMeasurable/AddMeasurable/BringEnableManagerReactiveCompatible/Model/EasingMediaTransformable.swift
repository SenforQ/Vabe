...
// __CLOSE_PRINT__
//
//  EasingMediaTransformable.swift
//
...
let show_intervalTitle = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let app_errVideoName = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let user_keySaltTitle = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct EasingMediaTransformable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""

...
@objc public enum RecordRelatableTarget: UInt {
...
@objc public enum SizeExpressionConvertible: UInt {
 ...
 */
//: @objcMembers public class SideCellData: TCommonCellData {
@objcMembers public class SideCellData: PokeAtCellData {
    ...
    public var direction: SizeExpressionConvertible = .MsgDirectionIncoming
    ...
    public var translateStatus: RecordRelatableTarget = .MsgTranslate_init
    ...
    public var msgModel: DataModel = DataModel()
    ...
    public var cellLayout: BroadcastAddLayoutReactiveCompatible!
    ...
    public init(direction: SizeExpressionConvertible) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.parentArrange()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = BroadcastAddLayoutReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = BroadcastAddLayoutReactiveCompatible(isIncomming: false)
    ...
    public override func fixing(_ width: CGFloat) -> CGFloat {

...
@objcMembers public class PokeAtCellData: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func fixing(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class SkipViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: PokeAtCellData?
    ...
    @objc dynamic public func create(with data: PokeAtCellData) {
        //: self.data = data
        self.data = data
    }
} 
...
// __CLOSE_PRINT__
//
//  BroadcastAddLayoutReactiveCompatible.swift
...
@objcMembers public class BroadcastAddLayoutReactiveCompatible: NSObject {
    ...
    class func logTime() -> BroadcastAddLayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = BroadcastAddLayoutReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func startPrompt() -> BroadcastAddLayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = BroadcastAddLayoutReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func layout() -> BroadcastAddLayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = BroadcastAddLayoutReactiveCompatible.init(isIncomming: false)
    ...
    class func kill() -> BroadcastAddLayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = BroadcastAddLayoutReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func needLayout() -> BroadcastAddLayoutReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = BroadcastAddLayoutReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout

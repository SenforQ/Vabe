 ...
 *
 *  MessageIndexHandle 协议和 MessageViewController 类。
...
@protocol MessageIndexHandle <NSObject>
...
- (void)custommed:(MessageViewController *)controller;
...
- (void)toed:(MessageViewController *)controller;
...
- (BOOL)examine:(MessageViewController *)controller up:(UIView *)view;
 ...
 */
//: - (SideCellData *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (SideCellData *)content:(MessageViewController *)controller viewInfo:(V2TIMMessage *)data;
 ...
 */
//: - (WireReactiveCompatible *)messageController:(TUIMessageController *)controller onShowMessageData:(SideCellData *)data;
- (WireReactiveCompatible *)impactPhoto:(MessageViewController *)controller camera:(SideCellData *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(WireReactiveCompatible *)cell;
- (void)reply:(MessageViewController *)controller messageAvatar:(WireReactiveCompatible *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(WireReactiveCompatible *)cell;
- (void)sinceMin:(MessageViewController *)controller view:(WireReactiveCompatible *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(SideCellData *)data;
- (void)errorMenu:(MessageViewController *)controller count:(NSInteger)menuType paintTheLily:(SideCellData *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(WireReactiveCompatible *)cell;
- (void)bottom:(MessageViewController *)controller send:(WireReactiveCompatible *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(SideCellData *)cellData;
- (void)context:(MessageViewController *)controller broadcastUniform:(SideCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(SideCellData *)cellData;
- (void)render:(MessageViewController *)controller info:(SideCellData *)cellData;
...
/**
 *  执行 MessageIndexHandle 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<MessageIndexHandle> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<SideCellData *> *)uiMsgs;

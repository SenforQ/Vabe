...
struct SongHandyJSON: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var messageType = 0
...
struct TitleTransformable: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""

...
fileprivate let const_addName:[UInt8] = [0x27,0x20,0x27,0x3a,0x66,0x2d,0x21,0x2a,0x2b,0x3c,0x74,0x67,0x6e,0x26,0x2f,0x3d,0x6e,0x20,0x21,0x3a,0x6e,0x2c,0x2b,0x2b,0x20,0x6e,0x27,0x23,0x3e,0x22,0x2b,0x23,0x2b,0x20,0x3a,0x2b,0x2a]

				private func wrapTop(key num: UInt8) -> UInt8 {
					return num ^ 78
				}

/*: "#F5F5F5" :*/
fileprivate let notiNameUrl:String = "#F5F5F5count view gift say"
...
class ScriptViewCell: UITableViewCell {
    ...
    var currenModel = EnableModelType()
    //: var index = 0
    var index = 0
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_addName.map{wrapTop(key: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var lineView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(notiNameUrl.prefix(7))))
        //: return view
        return view
        //: }()
    }()
...
extension ScriptViewCell {
    //: func setCell(model: TalkingLiveRoomOnlineListModel, index: Int) {
    func bottleUpwardUpScaleOfMeasurement(model: EnableModelType, index: Int) {
        //: currenModel = model
        currenModel = model
        //: self.index = index
        self.index = index
        ...
        IconImg.inclose(urlStr: model.headPic)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: levelIcon.image = UIImage.BundleImageNamed(name: "level_\(model.level )")
        levelIcon.image = UIImage.snapIcon(name: "level_\(model.level)")
    }
}

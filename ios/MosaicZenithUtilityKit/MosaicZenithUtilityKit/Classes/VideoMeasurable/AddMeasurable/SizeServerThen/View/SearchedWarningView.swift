...
fileprivate let userSizeEqualMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_tc_warn" :*/
fileprivate let user_infoFormat:String = "text modelicon_"

/*: "Live Warning" :*/
fileprivate let showAppTaskData:String = "path var add typeLive "
fileprivate let k_equalName:[Character] = ["W","a","r","n","i","n","g"]

/*: "Violation Reason: " :*/
fileprivate let show_topPath:String = "Violatioconstraint video main"
fileprivate let dataNameMessage:String = "player error returnn Re"

/*: "Warning Time: " :*/
fileprivate let noti_markData:[Character] = ["W","a","r","n","i","n","g"]
fileprivate let main_userValue:String = " Time: view true guard"
...
class SearchedWarningView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userSizeEqualMessage.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.snapIcon(name: (String(user_infoFormat.suffix(5)) + "tc_warn"))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.text = (String(showAppTaskData.suffix(5)) + String(k_equalName)).localized
        //: return lab
        return lab
        //: }()
    }()
...
extension SearchedWarningView {
    ...
    func kibbitz(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.titleDevice()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(show_topPath.prefix(8)) + String(dataNameMessage.suffix(4)) + "ason: ").localized
        ...
        var timeText = (String(noti_markData) + String(main_userValue.prefix(7))).localized

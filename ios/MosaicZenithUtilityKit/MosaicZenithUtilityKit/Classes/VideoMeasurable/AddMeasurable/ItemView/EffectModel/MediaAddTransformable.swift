...
@objc public enum ResumeVarArg: Int {
    //: case normal  = 1
    case normal = 1 // 普通礼物
    //: case myStery = 2
    case myStery = 2 // 盲盒礼物
...
struct MediaAddTransformable: HandyJSON {
    //: init() {
    init() {}
    ...
    mutating func pathTag(giftNum: Int) {
        //: self.num = giftNum
        self.num = giftNum
    }
}
...
struct GiftAnimatModel: HandyJSON {
    //: init() {
    init() {}

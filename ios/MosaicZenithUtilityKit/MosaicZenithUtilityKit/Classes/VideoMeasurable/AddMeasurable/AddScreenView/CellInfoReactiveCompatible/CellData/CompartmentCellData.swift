...
@objcMembers public class CompartmentCellData: PointReactiveCompatible {
    ...
    override public var msgModel: DataModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.viaShared(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func aboveStatus(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(notiDeviceName)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + ExamineedReactiveCompatible.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + ExamineedReactiveCompatible.share.loginUserMode.userID + ".png"
        ...
        let imageData = UIImage.input(image, trademarkWhite: 2 * 1024)

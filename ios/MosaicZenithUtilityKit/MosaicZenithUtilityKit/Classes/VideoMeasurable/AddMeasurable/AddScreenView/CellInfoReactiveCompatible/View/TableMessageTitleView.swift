...
fileprivate let userKeyFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "nav_back_black_nor" :*/
fileprivate let userLineMessage:String = "nav_view return path"
fileprivate let const_resultLayerContent:String = "_blatitle text with empty color"
fileprivate let appClearMsg:String = "ck_noradd type text equal self"

/*: "btn_detail_more" :*/
fileprivate let data_equalFormat:String = "btn_dif above"
fileprivate let noti_segmentId:[Character] = ["e","t","a"]
fileprivate let appBackgroundPath:[Character] = ["i","l","_","m","o","r","e"]

/*: "btn_chat_videocall" :*/
fileprivate let userNearUrl:String = "mobile selfbtn_"
fileprivate let appWithFormat:String = "idmodel"

/*: "icon_lounge" :*/
fileprivate let userMainName:[Character] = ["i","c","o","n","_"]
fileprivate let noti_showStretchName:String = "lounmake"

/*: "Official" :*/
fileprivate let show_hiddenData:[Character] = ["O","f","f","i","c","i","a","l"]

/*: "Online List" :*/
fileprivate let show_valueId:String = "Onlincollection count engine"
fileprivate let main_topDownName:[Character] = ["e"," ","L","i","s","t"]

/*: "icon_privateChat_intimate" :*/
fileprivate let appMyLabelTitle:String = "icon_pbutton equal user result text"
fileprivate let appUpStr:String = "tload"
fileprivate let notiBoyData:[Character] = ["C","h","a","t","_","i","n","t","i","m","a","t","e"]

/*: "#FF60B9" :*/
fileprivate let kBottomMessage:[Character] = ["#","F","F","6","0","B","9"]

/*: "Customer Care Center" :*/
fileprivate let notiCountLeadingName:[Character] = ["C","u","s","t","o","m","e","r"]
fileprivate let appTitleMsg:String = "with view black type video Care C"
fileprivate let constToTitle:[Character] = ["e","n","t","e","r"]

/*: "#48FF1E" :*/
fileprivate let data_smartTitle:String = "#48FF1Esend temp to input self"

/*: "Online" :*/
fileprivate let show_numberText:String = "Onlinelabel color"

/*: "#FF4B7F" :*/
fileprivate let user_equalStr:String = "height import manager#FF4B7F"

/*: "get json error" :*/
fileprivate let main_panMsg:[Character] = ["g","e","t"," ","j","s","o","n"," ","e"]
fileprivate let appLayerId:String = "hiddenhiddenohidden"

/*: "transform.rotation" :*/
fileprivate let kReloadMakeMessage:String = "tlocalan"
fileprivate let mainStyleFirstPath:String = "m.rotatfor count if"
fileprivate let notiMomentName:[Character] = ["i","o","n"]

/*: "transform.scale" :*/
fileprivate let app_makeMsg:String = "tcountan"
fileprivate let userFieldStr:String = "menucal"
fileprivate let notiSourceId:String = "point"

/*: "zoom&shake" :*/
fileprivate let userLiveKey:String = "zoom&smake gift library"
fileprivate let constGiftValue:String = "arrayake"
...
class TableMessageTitleView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userKeyFormat.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var backButton: UIButton = {
        ...
        let img = UIImage.snapIcon(name: (String(userLineMessage.prefix(4)) + "back" + String(const_resultLayerContent.prefix(4)) + String(appClearMsg.prefix(6)))).withRenderingMode(.alwaysTemplate)
    ...
    lazy var moreButton: UIButton = {
        ...
        let img = UIImage.snapIcon(name: (String(data_equalFormat.prefix(5)) + String(noti_segmentId) + String(appBackgroundPath))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var videoCallBtn: UIButton = {
        ...
        let img = UIImage.snapIcon(name: (String(userNearUrl.suffix(4)) + "chat_v" + appWithFormat.replacingOccurrences(of: "model", with: "eo") + "call")).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.snapIcon(name: (String(userMainName) + noti_showStretchName.replacingOccurrences(of: "make", with: "ge")))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    lazy var officalImgV: UIButton = {
        ...
        img.setTitle((String(show_hiddenData)).localized, for: .normal)
    ...
    lazy var onlineListBtn: UIButton = {
        ...
        btn.setTitle((String(show_valueId.prefix(5)) + String(main_topDownName)).localized, for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var onlineStatusV: GroupVideoControl = {
    ...
    private lazy var myBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(snapBeggarMyNeighborPolicy), for: .touchUpInside)
    ...
    private lazy var userBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(iconStart), for: .touchUpInside)
        //: btn.imageView?.contentMode = .scaleAspectFill
        btn.imageView?.contentMode = .scaleAspectFill
        //: btn.isHidden = true
        btn.isHidden = true
    ...
    private lazy var intimateBtn: UIButton = {
        ...
        btn.setImage(UIImage.snapIcon(name: (String(appMyLabelTitle.prefix(6)) + "riva" + appUpStr.replacingOccurrences(of: "load", with: "e") + String(notiBoyData))), for: .normal)
        //: btn.isHidden = true
        btn.isHidden = true
    ...
    private lazy var intimateLB: UILabel = {
        ...
        lb.textColor = UIColor(hex: (String(kBottomMessage)))
    ...
    private lazy var addIntimateLB: UILabel = {
        ...
        lb.font = UIFont.font(type: .Semibold, fontSize: 12)
        //: lb.isHidden = true
        lb.isHidden = true
...
extension TableMessageTitleView {
    //: func createSubViews() {
    func indexMethod() {
        ...
        if self.chatType == .service {
            ...
            titleLabel.text = (String(notiCountLeadingName) + String(appTitleMsg.suffix(7)) + String(constToTitle)).localized
            //: titleLabel.font = .pingfangFont(type: .Medium, fontSize: 18)
            titleLabel.font = .font(type: .Medium, fontSize: 18)
            //: titleLabel.textColor = .appTitleColor()
            titleLabel.textColor = .equalTarget()
    ...
    func legacy() {
        ...
        if self.chatType == .service { // 官方客服
            ...
            let offset = SizeLanguageManager.shared.direction == .leftToRight ? 22 : -22
    ...
    ///   - userModel: 用户信息
    ///   - isFrom: 列表控制器入口
    //: func private_updateNavView(userModel: BivouacCacheModel, isFrom: PrivateChatIsFromEnum) {
    func restore(userModel: BivouacCacheModel, isFrom: TitlePicFromEnum) {
        ...
        if userModel.onlineStatus == 1 {
            ...
            let image = UIImage.imageContent(color: UIColor(hex: (String(data_smartTitle.prefix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.sitting(), for: .normal)
            onlineStatusV.setImage(image.sitting(), for: .normal)
            //: onlineStatusV.setTitle("Online".localized, for: .normal)
            onlineStatusV.setTitle((String(show_numberText.prefix(6))).localized, for: .normal)
            ...
            let image = UIImage.imageContent(color: UIColor(hex: (String(user_equalStr.suffix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.sitting(), for: .normal)
            onlineStatusV.setImage(image.sitting(), for: .normal)
        ...
        titleLabel.textColor = userModel.loungePlus ? .utilizerForBodyCovering() : .white
        ...
        var videoCall = userModel.enableVideoCall
        //: if isFrom == .LiveRoom || ExamineedReactiveCompatible.share.appStatus == AppSkinStatus.special.rawValue {
        if isFrom == .LiveRoom || ExamineedReactiveCompatible.share.appStatus == InstanceHashableRepresentation.special.rawValue {
            //: videoCall = false
            videoCall = false
        }
        //: if videoCall {
    ...
    /// - Parameters:
    ///   - userModel: 用户信息
    //: func private_updateIntimateNavView(userModel: BivouacCacheModel) {
    func selectBy(userModel: BivouacCacheModel) {
        ...
        userBtn.isHidden = false
        //: myBtn.setUrlImage(urlStr: ExamineedReactiveCompatible.share.loginUserMode.headPic ?? "")
        myBtn.publicTransportSum(urlStr: ExamineedReactiveCompatible.share.loginUserMode.headPic ?? "")
        //: userBtn.setUrlImage(urlStr: userModel.headPic)
        userBtn.publicTransportSum(urlStr: userModel.headPic)
    ...
    func animSumimate(intimate: Int) {
        //: let str  = "+\(intimate)"
        let str = "+\(intimate)"
        ...
        let attributes = [.foregroundColor: UIColor.white, .font: UIFont.font(type: .Semibold, fontSize: 12)] as [NSAttributedString.Key: Any]
        ...
        let url = ValueReactiveCompatible.default.express(type: .Private_Chat_intimate)
        //: do {
        do {
            ...
            printLog(message: (String(main_panMsg) + appLayerId.replacingOccurrences(of: "hidden", with: "r")))
        }
    }
    ...
    func exhibitTop(intimate: Int) {
        //: intimateLB.text = "\(intimate)"
        intimateLB.text = "\(intimate)"
    }

    //: @objc func myBtnClick() {
    @objc func snapBeggarMyNeighborPolicy() {
        //: AppPushManager.share.func__pushToUserDetailVC(uid: ExamineedReactiveCompatible.share.loginUserMode.userID)
        AppPushManager.share.enrich(uid: ExamineedReactiveCompatible.share.loginUserMode.userID)
    }

    //: @objc func userIconClick() {
    @objc func iconStart() {
        //: AppPushManager.share.func__pushToUserDetailVC(uid: userId)
        AppPushManager.share.enrich(uid: userId)
    }
    ...
    @objc func demonstrate() {
        ...
        let view = ServerLabParadigmReactiveCompatible(frame: CGRect(x: 0, y: 0, width: user_barText, height: show_licenseData))
        //: view.show()
        view.useMedium()
    }

    //: func videoCallBtnAnimat() {
    func methodActionAnimat() {
        ...
        let roate = CAKeyframeAnimation(keyPath: (kReloadMakeMessage.replacingOccurrences(of: "local", with: "r") + "sfor" + String(mainStyleFirstPath.prefix(7)) + String(notiMomentName)))
        ...
        let zoom = CAKeyframeAnimation(keyPath: (app_makeMsg.replacingOccurrences(of: "count", with: "r") + "sform." + userFieldStr.replacingOccurrences(of: "menu", with: "s") + notiSourceId.replacingOccurrences(of: "point", with: "e")))
        ...
        videoCallBtn.layer.add(groupAnnimation, forKey: (String(userLiveKey.prefix(6)) + constGiftValue.replacingOccurrences(of: "array", with: "h")))
    }
}

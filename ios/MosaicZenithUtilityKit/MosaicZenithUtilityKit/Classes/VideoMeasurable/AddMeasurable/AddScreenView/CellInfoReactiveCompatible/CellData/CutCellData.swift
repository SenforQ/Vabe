...
/*: "bg_chat_honey_left" :*/
fileprivate let constStyleMsg:String = "bg_chcase fill self send"
fileprivate let constSkipMessage:String = "oney_lebackground in snap"
fileprivate let constTimeFormat:String = "title"

/*: "bg_chat_honey_right" :*/
fileprivate let k_genData:String = "bar self bottombg_cha"
fileprivate let constShareStr:[Character] = ["t","_","h","o","n","e","y","_","r","i","g","h","t"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let constManagerToMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#FA74B7" :*/
fileprivate let app_makeNeedKey:String = "#FA74B7item with conversation true"

/*: "icon_coin" :*/
fileprivate let notiCellModelId:String = "icon_coitext else"
fileprivate let appGiftKey:[Character] = ["n"]
...
//: @objcMembers public class CutCellData: TalkingChatMsgBaseCellData {
@objcMembers public class CutCellData: PointReactiveCompatible {
    ...
    override public init(direction: SizeExpressionConvertible) {
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.bubbleImg = UIImage.stillbirth(name: (String(constStyleMsg.prefix(5)) + "at_h" + String(constSkipMessage.prefix(7)) + constTimeFormat.replacingOccurrences(of: "title", with: "ft")))
            ...
            self.bubbleImg = UIImage.stillbirth(name: (String(k_genData.suffix(6)) + String(constShareStr)))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constManagerToMsg.reversed(), encoding: .utf8)!)
    }
    ...
    public lazy var attributedString: NSMutableAttributedString = {
        ...
        let attr = icon(giftModel: self.msgModel)
        //: return attr
        return attr
        //: }()
    }()
    ...
    func icon(giftModel: DataModel) -> NSMutableAttributedString {
        //: let attr = NSMutableAttributedString.init()
        let attr = NSMutableAttributedString()
        //: let font = UIFont.pingfangRugularFont(fontSize: 16)
        let font = UIFont.easing(fontSize: 16)
        //: let giftname = changeGiftName(giftmodel: giftModel.msgInfo.wantGift)
        let giftname = estimated(giftmodel: giftModel.msgInfo.wantGift)
        ...
        let attr1 = NSMutableAttributedString(string: str, attributes: [.font: font, .foregroundColor: UIColor.equalTarget()])
        //: let attr2 = NSMutableAttributedString.init(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor.init(hex: "#FA74B7")!])
        let attr2 = NSMutableAttributedString(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(app_makeNeedKey.prefix(7))))!])
        ...
        let attr3 = NSMutableAttributedString(string: "\(giftModel.msgInfo.wantGift.giftPrice)", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(app_makeNeedKey.prefix(7))))!])
        ...
        giftImgV.methodSet(urlStr: giftModel.msgInfo.wantGift.giftIcon)
        ...
        giftImgV2.image = UIImage.snapIcon(name: (String(notiCellModelId.prefix(8)) + String(appGiftKey)))
    ...
    func estimated(giftmodel: TitleModel) -> String {
        ...
        if RecordAddrTool.share.interfaceLang == ModelHostSendable.en.rawValue {
            ...
            gameName = giftmodel.giftNameI18n[ModelHostSendable.en.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ModelHostSendable.ar.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ModelHostSendable.es.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ModelHostSendable.pt.rawValue] as? NSString ?? ""
        }

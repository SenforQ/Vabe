...
fileprivate let show_indicatorData:[UInt8] = [0xf0,0xf7,0xf0,0xed,0xb1,0xfa,0xf6,0xfd,0xfc,0xeb,0xa3,0xb0,0xb9,0xf1,0xf8,0xea,0xb9,0xf7,0xf6,0xed,0xb9,0xfb,0xfc,0xfc,0xf7,0xb9,0xf0,0xf4,0xe9,0xf5,0xfc,0xf4,0xfc,0xf7,0xed,0xfc,0xfd]

				private func labInput(social num: UInt8) -> UInt8 {
					return num ^ 153
				}
...
class FinancialAidReactiveCompatible: VocalizationMsgCell {
    //: var giftData: PlayerCellData?
    var giftData: PlayerCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_indicatorData.map{labInput(social: $0)}, encoding: .utf8)!)
    }
...
extension FinancialAidReactiveCompatible {
    ...
    override func create(with data: PokeAtCellData) {
        ...
        //: self.giftData = data as? PlayerCellData
        self.giftData = data as? PlayerCellData

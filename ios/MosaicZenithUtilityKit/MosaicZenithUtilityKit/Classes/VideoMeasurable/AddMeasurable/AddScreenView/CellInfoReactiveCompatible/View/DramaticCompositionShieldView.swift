...
fileprivate let main_makeMessage:[UInt8] = [0x3a,0x3d,0x3a,0x27,0x7b,0x30,0x3c,0x37,0x36,0x21,0x69,0x7a,0x73,0x3b,0x32,0x20,0x73,0x3d,0x3c,0x27,0x73,0x31,0x36,0x36,0x3d,0x73,0x3a,0x3e,0x23,0x3f,0x36,0x3e,0x36,0x3d,0x27,0x36,0x37]

				private func makeRange(index num: UInt8) -> UInt8 {
					return num ^ 83
				}
...
// __CLOSE_PRINT__
//
//  DramaticCompositionShieldView.swift
//  AbroadTalking
//
...
class DramaticCompositionShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func pressTime(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return DramaticCompositionShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_makeMessage.map{makeRange(index: $0)}, encoding: .utf8)!)
    }
...
extension DramaticCompositionShieldView {

...
@interface AggregationModel : JSONModel
...
@property (nonatomic, strong) RequestPermissionModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) ClearSendModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) AspectModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) TitleModel *wantGift; /// 想要礼物
...
@interface RequestPermissionModel : JSONModel
...
+ (void)unwished:(RequestPermissionModel *)photoModel age:(NSString *)msgID;
...
@interface ClearSendModel: JSONModel
...
+ (void)unwanted:(ClearSendModel *)videoModel mediaBy:(NSString *)msgID;
...
@interface AspectModel: JSONModel
...
@interface AstatineModel : JSONModel
...
@interface DirectionModel : JSONModel
...
@interface HiddenModel : JSONModel
...
@interface CancelModel : JSONModel
...
@property (nonatomic, strong) DisplaceModel *renderData;

//: - (BOOL)isQuoteMsg;
- (BOOL)tvMsg;

//: - (CGSize)quoteSize:(NSInteger)maxWidth;
- (CGSize)session:(NSInteger)maxWidth;

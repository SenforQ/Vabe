...
fileprivate let appScreenPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#292929" :*/
fileprivate let userEqualStr:String = "#2object2object2object"

/*: "9999999" :*/
fileprivate let mainCellText:String = "requestrequestrequestrequestrequestrequestrequest"

/*: "icon_coin" :*/
fileprivate let kToUrl:String = "text copyicon_"

/*: "icon_gift_more_arrow" :*/
fileprivate let notiEqualMsg:String = "icon_view array then var video"
fileprivate let noti_playKey:String = "ore_arrreturn object"
fileprivate let const_bottomMakeName:String = "OW"

/*: "icon_gift_num_arrow" :*/
fileprivate let kToMsg:String = "icowith"
fileprivate let userPostValue:String = "model task item level_num_"

/*: "nav_back_black_nor" :*/
fileprivate let appLeadingTitle:String = "nav_icon attribute"
fileprivate let show_bubbleData:[Character] = ["b"]
fileprivate let noti_diskId:[Character] = ["l","a","c","k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let data_lowPath:[UInt8] = [0x89,0x9d,0x9a,0x55,0xa3,0xaa,0xa2,0x97,0x9a,0xa7,0x55,0xa4,0x9b,0x55,0x9c,0x9e,0x9b,0xa9,0xa8,0x55,0x98,0x96,0xa3,0xa3,0xa4,0xa9,0x55,0x97,0x9a,0x55,0xa1,0x9a,0xa8,0xa8,0x55,0xa9,0x9d,0x96,0xa3,0x55,0x66]

				fileprivate func showInvite(player num: UInt8) -> UInt8 {
...
fileprivate let dataPhoneValue:[Character] = ["P","l","e","a","s","e"," "]
fileprivate let main_textMsg:[Character] = ["s","e","l","e","c","t"," ","a"," ","g","i","f","t"]

/*: "Please select an object" :*/
fileprivate let k_descriptionUrl:String = "Pleasdata return across gift mode"
fileprivate let const_blockName:[Character] = [" ","a","n"," ","o","b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let appStartTitle:[UInt8] = [0x6b,0x63,0x6f,0x6c,0x6e,0x75,0x20,0x6f,0x74,0x20,0x74,0x66,0x69,0x67,0x20,0x64,0x65,0x72,0x69,0x73,0x65,0x64,0x20,0x65,0x68,0x74,0x20,0x74,0x63,0x65,0x6c,0x65,0x53]

/*: "Select object >" :*/
fileprivate let noti_bottomNoId:[Character] = ["S","e","l","e","c","t"," ","o","b","j","e","c","t"," ",">"]

/*: "It looks like there's nothing" :*/
fileprivate let showProgressMessage:String = "It lup extension gift to var"
fileprivate let mainButtonManagerValue:String = "clear for like "
fileprivate let user_toData:String = "there\'"
fileprivate let appPhotoUrl:String = "hipingg"

/*: "FF75A4" :*/
fileprivate let user_countMsg:String = "want"
fileprivate let appDataId:[Character] = ["F","7","5","A","4"]

/*: "E570FF" :*/
fileprivate let kTouchMessage:String = "E570main"

/*: "Ask for" :*/
fileprivate let mainReloadDetailCutKey:String = "bottom as secondAsk for"

/*: " Select %@ > " :*/
fileprivate let constObjectTitle:[Character] = [" ","S","e","l","e","c","t"," ","%","@"," "]
fileprivate let constToolStr:[Character] = [">"," "]

/*: "All Numbers" :*/
fileprivate let user_miniTitle:[Character] = ["A","l","l"," ","N","u","m","b","e","r","s"]

/*: "View detailed description >" :*/
fileprivate let noti_withColorImageValue:String = "connection snap guard if inView "
fileprivate let app_progressContent:String = "count data user video inviteled d"
fileprivate let k_upData:String = "on >for height lab"

/*: "Custom" :*/
fileprivate let notiRequestUrl:String = "view self lab player stackCustom"

/*: "mf_coin" :*/
fileprivate let showPlayerSkinKey:[Character] = ["m","f","_","c","o","i","n"]

/*: "showBagsRed" :*/
fileprivate let main_colorTitle:String = "shadow to list make varshowB"
fileprivate let notiObjectPath:[Character] = ["a","g","s","R","e","d"]
...
enum SunnahTransformable: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
enum CopernicanSystemHashable: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: HeadTransformable, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: HeadTransformable, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: HeadTransformable) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: HeadTransformable, _ num: String, _ model: VoiceMeasurable) -> Void
// 隐藏礼物面板Block
...
private let kNameText = 44.0
//: let GiftScrollContentView_H = 252.0
let userBarUrl = 252.0
//: private let pageControl_H = 7.0
private let kReplaceScreenFormat = 7.0
//: private let bottomView_H = 44.0
private let main_toMessage = 44.0

//: class TalkingChatGiftView: UIView {
class PolePositionGiftView: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = kNameText + userBarUrl + kReplaceScreenFormat + main_toMessage + dataShowText
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [CopernicanSystemHashable]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = CopernicanSystemHashable.Hot
    ...
    init(frame: CGRect = .zero, style: SunnahTransformable = .normal, titlesArr: [CopernicanSystemHashable] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appScreenPath.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: show_licenseData, width: user_barText, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (userEqualStr.replacingOccurrences(of: "object", with: "9")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.areaRecordRadii(width: user_barText, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: CenterDataSource = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: user_barText, height: app_iconMessage)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = CenterDataSource(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: user_barText, height: kNameText)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (userEqualStr.replacingOccurrences(of: "object", with: "9")))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: GroupVideoControl = {
        //: let btn = TalkingButton()
        let btn = GroupVideoControl()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.font(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((mainCellText.replacingOccurrences(of: "request", with: "9")), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.snapIcon(name: (String(kToUrl.suffix(5)) + "coin")), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(roundWith), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.snapIcon(name: (String(notiEqualMsg.prefix(5)) + "gift_m" + String(noti_playKey.prefix(7)) + const_bottomMakeName.lowercased()))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.underReadingRgba(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.underReadingRgba(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        let layout = EqualCenterReactiveCompatible()
        ...
        hot.register(TextReusableView.self, forCellWithReuseIdentifier: TextReusableView.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: EqualCenterReactiveCompatible = //: return hotGiftCollectionView.collectionViewLayout as! EqualCenterReactiveCompatible
        hotGiftCollectionView.collectionViewLayout as! EqualCenterReactiveCompatible
    //: }()
    ...
    private lazy var titleScrollView: CentreStageView = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        let scrollview = CentreStageView(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(kNameText)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if SizeLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = PicMacroDefine.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = PicMacroDefine.sharedObject() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !SelectedReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var giftNumButton: GroupVideoControl = {
        ...
        btn.setImage(UIImage.snapIcon(name: (kToMsg.replacingOccurrences(of: "with", with: "n") + "_gift" + String(userPostValue.suffix(5)) + "arrow")), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(aboutFor), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.font(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.titleDevice()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle("Send".localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(seekData), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: show_licenseData - CGFloat(keyborHeight) - 44, width: user_barText, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.snapIcon(name: (String(appLeadingTitle.prefix(4)) + "back_" + String(show_bubbleData) + String(noti_diskId))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.errorHeritage(color: .titleDevice(), forState: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.heatherMixtureMoment(showMsg: String(bytes: data_lowPath.map{showInvite(player: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.heatherMixtureMoment(showMsg: (String(dataPhoneValue) + String(main_textMsg)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.heatherMixtureMoment(showMsg: (String(k_descriptionUrl.prefix(5)) + "e select" + String(const_blockName)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = CopernicanSystemHashable(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.get(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: HeadTransformable = dataArr[index] as! HeadTransformable
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.titleDevice()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(phoneFrom(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(glassNotification(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(punctuate(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: appStartTitle.reversed(), encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(naturalResources), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(noti_bottomNoId)).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(accountingDataClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.font(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(showProgressMessage.prefix(4)) + "ooks" + String(mainButtonManagerValue.suffix(6)) + user_toData + "s not" + appPhotoUrl.replacingOccurrences(of: "ping", with: "n")).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.resourceIn(colors: [UIColor(hex: (user_countMsg.replacingOccurrences(of: "want", with: "F") + String(appDataId)))!.cgColor, UIColor(hex: (kTouchMessage.replacingOccurrences(of: "main", with: "FF")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.font(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(mainReloadDetailCutKey.suffix(7))).localized, for: .normal)
...
extension PolePositionGiftView {
    /// 隐藏视图
    //: @objc func dismissView() {
    @objc func deadlineCurrency() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: show_licenseData, width: user_barText, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func listWith() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: show_licenseData - self.contentHeight, width: user_barText, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func naturalResources() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = CopernicanSystemHashable(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.get(dataType: dataType)
    ...
    @objc func build() {
        ...
        meneView = PushSelectDataSource(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func accountingDataClick() {
        //: dismissView()
        deadlineCurrency()
        //: AppPushManager.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        AppPushManager.share.curvet(webViewType: .luckyBlindBox)
    }
...
extension PolePositionGiftView {
    ...
    func sexAction(pkgItemsetId: String, num: Int) {
        ...
        DispatchQueue.main.async {
            ...
            SelectedReactiveCompatible.share.solicitation(dataType: self.currType, dataArr: bagsDataArr)
...
extension PolePositionGiftView: ReloadViewDelegate {
    ...
    func equalDoing(model: VoiceMeasurable) {
        ...
        seleteObjectBtn.setTitle((String(constObjectTitle) + String(constToolStr)).equalKey(model.nickname), for: .normal)
    }
    ...
    func headspring() {
        ...
        if model.nickname == (String(user_miniTitle)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! VoiceMeasurable
    ...
    func searchedText(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(noti_withColorImageValue.suffix(5)) + "detai" + String(app_progressContent.suffix(5)) + "escripti" + String(k_upData.prefix(4))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension PolePositionGiftView: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func get(dataType: CopernicanSystemHashable) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return SelectedReactiveCompatible.share.referenceType(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func viewEqual() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return SelectedReactiveCompatible.share.toAll()
    }
    ...
    func telephoneMessage(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == ReloadInsetTarget.myStery.rawValue)
        }
    ...
    @objc func punctuate(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: show_licenseData - CGFloat(keyborHeight) - 44, width: user_barText, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func glassNotification(notification _: NSNotification) {
    ...
    func freebee() {
        ...
        let sendingItems = viewEqual()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(familyName(index: i))
//            let giftNumArrModel: EqualHandyJSON = sendingItems[i] as! EqualHandyJSON
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(notiRequestUrl.suffix(6))).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.LoadConfig.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = NameView.timeMenuRead(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func showNum() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? TextReusableView
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.telecasting(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = CopernicanSystemHashable(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = get(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = TextReusableView.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TextReusableView
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = CopernicanSystemHashable(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = get(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: HeadTransformable = dataArr[indexPath.row] as! HeadTransformable
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.drownAdd(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.drawChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = CopernicanSystemHashable(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = get(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == ReloadInsetTarget.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == ReloadInsetTarget.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == ReloadInsetTarget.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                personBar(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = harvestMoonNum(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = beautyIndex(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            personBar(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: TextReusableView = giftSelectedModel.lastHotCell as! TextReusableView
                //: cell.setChecked(checked: false)
                cell.drawChecked(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: TextReusableView = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TextReusableView
            //: currentCell.setChecked(checked: true)
            currentCell.drawChecked(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.contentAnimated(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.get(dataType: self.currType)
    ...
    func listForce(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + user_barText
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < user_barText ? user_barText : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / user_barText - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(user_barText) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = CopernicanSystemHashable.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = SelectedReactiveCompatible.share.perShared(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.counterval(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && ExamineedReactiveCompatible.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == CopernicanSystemHashable.Hot && self.style == .normal && ExamineedReactiveCompatible.share.loginUserMode.sex == CommentRefCompatibleValue.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == ReloadInsetTarget.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                searchedText(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func rating() {
        ...
        self.giftSelectedModel = StreamHandyJSON()
...
extension PolePositionGiftView: WithViewDelegate {
    ...
    func personBar(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.upward(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.bound(view: self.window!)
    ...
    func familyName(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: EqualHandyJSON = sendingItems[index] as! EqualHandyJSON
    ...
    func harvestMoonNum(num: Int) -> Int {
        //: var index = 0
        var index = 0
        //: for i in 0..<giftSendItems().count {
        for i in 0 ..< viewEqual().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: EqualHandyJSON = viewEqual()[i] as! EqualHandyJSON
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func beautyIndex(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > viewEqual().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension PolePositionGiftView {
    ...
    private func behindTable() {
        //: self.backgroundColor = UIColor.clear
        self.backgroundColor = UIColor.clear
        //: let tagView = UIView.init(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight-contentHeight))
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: user_barText, height: show_licenseData - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(deadlineCurrency)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(userBarUrl)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(user_barText)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(user_barText - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(kReplaceScreenFormat)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(main_toMessage)
        }
    ...
    private func previous() {
        //: ExamineedReactiveCompatible.share.loginUserMode.rx
        ExamineedReactiveCompatible.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(showPlayerSkinKey)))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.telephoneMessage(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        SelectedReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(main_colorTitle.suffix(5)) + String(notiObjectPath)))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                SelectedReactiveCompatible.share.colorCompletion(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: ExamineedReactiveCompatible.share.loginUserMode.mf_coin)
                    self.telephoneMessage(needReload: true, mf_coin: ExamineedReactiveCompatible.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })

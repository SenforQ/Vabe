...
open class SearchedHasDelegate: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = SearchedHasDelegate.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {

...
enum EleventhHourColumnConvertible: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum RequestModelKeyRepresentable: String {
    //: case AppleLogin
...
/// 性别
//: enum Gender: String {
enum CommentRefCompatibleValue: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum VoiceClusterLiteral: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum HeadeColumnConvertible: Int {
    //: case isOnGoing = 0
...
enum ExamineTermConvertible: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum InstanceHashableRepresentation: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum HeadingHashable: Int {
    //: case Unavailable = 0
...
enum DisappearScriptExpressionConvertible: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2

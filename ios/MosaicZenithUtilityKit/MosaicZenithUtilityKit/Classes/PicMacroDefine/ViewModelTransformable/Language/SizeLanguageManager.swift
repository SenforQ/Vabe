...
@objcMembers open class SizeLanguageManager: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = SizeLanguageManager()
    //: private(set) var currLanguage: String = PicMacroDefine.getSystemLangCode()
    private(set) var currLanguage: String = PicMacroDefine.confinementDoing()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func colorSuperstratum(_ language: String) {
...
extension String {
    ...
    public func equalKey(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = ValueReactiveCompatible.default.languagePath

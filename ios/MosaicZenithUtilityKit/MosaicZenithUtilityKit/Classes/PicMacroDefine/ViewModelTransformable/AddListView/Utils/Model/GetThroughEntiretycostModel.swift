...
// __CLOSE_PRINT__
//
//  GetThroughEntiretycostModel.swift
//  AbroadTalking
//
...
//: @objcMembers public class GetThroughEntiretycostModel: JSONModel {
@objcMembers public class GetThroughEntiretycostModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = RegisterDefaultsSerializable.Face
...
//: @objc extension GetThroughEntiretycostModel {
@objc extension GetThroughEntiretycostModel {
    //: func initWith(suiteType: BeautyItemType)-> GetThroughEntiretycostModel {
    func dismissExit(suiteType: RegisterDefaultsSerializable) -> GetThroughEntiretycostModel {
        //: let model = GetThroughEntiretycostModel.init()
        let model = GetThroughEntiretycostModel()
        //: model.beautySuite = suiteType
        model.beautySuite = suiteType
        //: model.resetBeautySuiteValueFor()
        model.beforeUnwantedFor()
        //: return model
        return model
    }

    //: func resetBeautySuiteValueFor() {
    func beforeUnwantedFor() {

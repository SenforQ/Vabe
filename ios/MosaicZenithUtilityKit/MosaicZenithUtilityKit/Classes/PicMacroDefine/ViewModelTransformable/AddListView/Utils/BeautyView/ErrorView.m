...
@property (nonatomic, copy) NSString *user_appBlockStr;

//: M_SenseME_Face_Video_5.3.4
@property (nonatomic, copy) NSString *userEventListId;

//: hasFace
@property (nonatomic, copy) NSString *notiEventName;

//: FaceActionEvent_Interval_1_second
@property (nonatomic, copy) NSString *constRetStr;

//: key.Notification.Tap.To.Modify.Exposure.Point
@property (nonatomic, copy) NSString *kTitleValue;

//: camera_focus_red
@property (nonatomic, copy) NSString *constPlayerPath;
...
+ (NSData *)TotalDataToData:(NSArray<NSString *> *)value {
...
- (Byte *)TotalDataToByte:(StructTotalData *)data {
    for (int i = 0; i < data->alter; i++) {
        data->resource[i] ^= data->seek;
    }
    data->resource[data->alter] = 0;
	if (data->alter >= 2) {
		data->direction = data->resource[0];
		data->operationDevice = data->resource[1];
	}
    return data->resource;
}

- (NSString *)StringFromTotalData:(StructTotalData *)data {
    return [NSString stringWithUTF8String:(char *)[self TotalDataToByte:data]];
}

//: M_SenseME_Face_Video_5.3.4
- (NSString *)userEventListId {
    if (!_userEventListId) {
		NSArray<NSString *> *origin = @[@"149", @"135", @"139", @"189", @"182", @"171", @"189", @"149", @"157", @"135", @"158", @"185", @"187", @"189", @"135", @"142", @"177", @"188", @"189", @"183", @"135", @"237", @"246", @"235", @"246", @"236", @"66"];
		NSData *data = [TotalData TotalDataToData:origin];
        StructTotalData value = (StructTotalData){216, (Byte *)data.bytes, 26, 129, 90};
        _userEventListId = [self StringFromTotalData:&value];
    }
    return _userEventListId;
}

//: FaceActionEvent_Interval_1_second
- (NSString *)constRetStr {
    if (!_constRetStr) {
		NSArray<NSString *> *origin = @[@"33", @"6", @"4", @"2", @"38", @"4", @"19", @"14", @"8", @"9", @"34", @"17", @"2", @"9", @"19", @"56", @"46", @"9", @"19", @"2", @"21", @"17", @"6", @"11", @"56", @"86", @"56", @"20", @"2", @"4", @"8", @"9", @"3", @"6"];
		NSData *data = [TotalData TotalDataToData:origin];
        StructTotalData value = (StructTotalData){103, (Byte *)data.bytes, 33, 247, 151};
        _constRetStr = [self StringFromTotalData:&value];
    }
    return _constRetStr;
}

//: camera_focus_red
- (NSString *)constPlayerPath {
    if (!_constPlayerPath) {
		NSArray<NSString *> *origin = @[@"141", @"143", @"131", @"139", @"156", @"143", @"177", @"136", @"129", @"141", @"155", @"157", @"177", @"156", @"139", @"138", @"14"];
		NSData *data = [TotalData TotalDataToData:origin];
        StructTotalData value = (StructTotalData){238, (Byte *)data.bytes, 16, 193, 184};
        _constPlayerPath = [self StringFromTotalData:&value];
    }
    return _constPlayerPath;
}

//: FaceActionEvent_Interval_12_frame
- (NSString *)user_appBlockStr {
    if (!_user_appBlockStr) {
		NSArray<NSString *> *origin = @[@"230", @"193", @"195", @"197", @"225", @"195", @"212", @"201", @"207", @"206", @"229", @"214", @"197", @"206", @"212", @"255", @"233", @"206", @"212", @"197", @"210", @"214", @"193", @"204", @"255", @"145", @"146", @"255", @"198", @"210", @"193", @"205", @"197", @"119"];
		NSData *data = [TotalData TotalDataToData:origin];
        StructTotalData value = (StructTotalData){160, (Byte *)data.bytes, 33, 229, 145};
        _user_appBlockStr = [self StringFromTotalData:&value];
    }
    return _user_appBlockStr;
}

//: hasFace
- (NSString *)notiEventName {
    if (!_notiEventName) {
		NSArray<NSString *> *origin = @[@"6", @"15", @"29", @"40", @"15", @"13", @"11", @"12"];
		NSData *data = [TotalData TotalDataToData:origin];
        StructTotalData value = (StructTotalData){110, (Byte *)data.bytes, 7, 50, 193};
        _notiEventName = [self StringFromTotalData:&value];
    }
    return _notiEventName;
}

//: key.Notification.Tap.To.Modify.Exposure.Point
- (NSString *)kTitleValue {
    if (!_kTitleValue) {
		NSArray<NSString *> *origin = @[@"126", @"112", @"108", @"59", @"91", @"122", @"97", @"124", @"115", @"124", @"118", @"116", @"97", @"124", @"122", @"123", @"59", @"65", @"116", @"101", @"59", @"65", @"122", @"59", @"88", @"122", @"113", @"124", @"115", @"108", @"59", @"80", @"109", @"101", @"122", @"102", @"96", @"103", @"112", @"59", @"69", @"122", @"124", @"123", @"97", @"23"];
		NSData *data = [TotalData TotalDataToData:origin];
        StructTotalData value = (StructTotalData){21, (Byte *)data.bytes, 45, 26, 126};
        _kTitleValue = [self StringFromTotalData:&value];
    }
    return _kTitleValue;
}
...
//
//#import "ModificationThen.h"
//#import "RepresentChromosphereReactiveCompatible.h"
//ST_MOBILE
...
@interface ErrorView ()<FromHidden,UIGestureRecognizerDelegate>
{
...
//: @property (nonatomic, strong) SearchedLicHelper * lichelper;
@property (nonatomic, strong) SearchedLicHelper * lichelper;
//: @property (nonatomic, strong) STParamUtil * ParamUtil;
@property (nonatomic, strong) SearchThen * ParamUtil;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        //: self.lichelper = [SearchedLicHelper share];
        self.lichelper = [SearchedLicHelper share];
        //: self.ParamUtil = [[STParamUtil alloc]init];
        self.ParamUtil = [[SearchThen alloc]init];
        //: _currentDropCount = 5;
        ...
        if ([self.lichelper beforeMenu]) {
            ...
            //: [[ModificationThen share] getLocalModel];
            [[ModificationThen share] modelStart];

            //: [self addNotifications];
            [self burn];

            //: [self setDefaultValue];
            [self duringNameureValue];
            ...
            [NSNotificationCenter.defaultCenter addObserver:self
                                                   ...
                                                   selector:@selector(lengthed:)
                                                       //: name:@"key.Notification.Tap.To.Modify.Exposure.Point"
                                                       name:[TotalData sharedInstance].kTitleValue
                                                     //: object:nil];
                                                     object:nil];
            ...
            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(layerRange:) name:self.ParamUtil.kNotificationSelectBeautyFilterStr object:nil];
            ...
            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(pauses:) name:self.ParamUtil.kNotificationBeautyFilterValueChangeStr object:nil];
...
- (instancetype)initMain:(NSString*)sessionPreset {
    ...
    if (self = [super init]) {
        ...
        if ([self.lichelper beforeMenu]) {
            ...
            [self initTimeActive:sessionPreset];

        //: } else {
        } else {
            //: [SearchedLicHelper.share checkRemoteLicInfoWithCompletion:^(BOOL x) {
            [SearchedLicHelper.share underViewWithCompletion:^(BOOL x) {
                //: if (x) {
                if (x) {
                    //: [self initFilterView:sessionPreset];
                    [self initTimeActive:sessionPreset];
...
- (void)initTimeActive:(NSString*)sessionPreset {
    //: self.layer.masksToBounds = YES;
    self.layer.masksToBounds = YES;
    //: self.clipsToBounds = YES;
    self.clipsToBounds = YES;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(layerRange:)
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(pauses:)
                                                 //: name:self.ParamUtil.kNotificationBeautyFilterValueChangeStr object:nil];
                                                 name:self.ParamUtil.kNotificationBeautyFilterValueChangeStr object:nil];
}

//: - (void)setDefaultValue {
- (void)duringNameureValue {
...
- (void)foil {
    ...
    //: if ([ModificationThen share].filterSuite.filterModelPath.length > 0) {
    if ([ModificationThen share].filterSuite.filterModelPath.length > 0) {
        //: RepresentChromosphereReactiveCompatible* model = [[ModificationThen share] getFilterDataModel];
        RepresentChromosphereReactiveCompatible* model = [[ModificationThen share] hangTogether];
        //: if (model) {
        if (model) {
...
- (void)setCurrentSessionPreset:(NSString *)currentSessionPreset {
    ...
    [self.stCamera property:self.previewCenter teeUp:self.previewFrame];
}
...
- (void)media:(BOOL)isFullScreen {
    ...
    [self eye:width imageHeight:height];
}
/// 设置视频通话预览的采集大小
...
- (void)icon {
    ...
    _stCamera = [[TransformCamera alloc] initWithAssemblage:AVCaptureDevicePositionFront
                                          //: sessionPresset:self.currentSessionPreset
                                          currentnessMessage:self.currentSessionPreset
                                                     //: fps:fps
                                                     showNeed:fps
                                           //: needYuvOutput:NO];
                                           active:NO];
...
- (void)eye:(CGFloat)width imageHeight:(CGFloat)height {
    //: CGRect previewRect = [self.stCamera getScaleRect:CGRectMake(0 , 0 , width, height)
    CGRect previewRect = [self.stCamera strength:CGRectMake(0 , 0 , width, height)
                                                   //: scaleToFit:NO];
                                                   appFit:NO];
    ...
    if (self.glPreview.superview == nil) {
        ...
        @synchronized (self) {
           ...
           _glPreview = [[FillMView alloc] initWithManager:previewRect show:previewContext];
        }
...
- (void)burn {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(longnessSample) name:UIApplicationWillResignActiveNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appDidEnterBackground) name:UIApplicationDidEnterBackgroundNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(noApp) name:UIApplicationDidEnterBackgroundNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appWillEnterForeground) name:UIApplicationWillEnterForegroundNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(messageTo) name:UIApplicationWillEnterForegroundNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appDidBecomeActive) name:UIApplicationDidBecomeActiveNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(pointBlank) name:UIApplicationDidBecomeActiveNotification object:nil];
}
...
- (void)headHandle {
    ...
    //初始化检测模块句柄
    //: NSString *strModelPath = [PicMacroDefine.getModelFileName stringByAppendingPathComponent:@"M_SenseME_Face_Video_5.3.4"];
    NSString *strModelPath = [PicMacroDefine.getOn stringByAppendingPathComponent:[TotalData sharedInstance].userEventListId];
...
- (void)initNapResolution {
    // 创建结果纹理
    //: [self setupTextureWithPixelBuffer:&_cvBeautifyBuffer
    [self smoothness:&_cvBeautifyBuffer
                                    //: w:self.imageWidth
                                    file:self.imageWidth
                                    //: h:self.imageHeight
                                    toContenture:self.imageHeight
                            //: glTexture:&_textureBeautifyOutput
                            harvestMoon:&_textureBeautifyOutput
                            //: cvTexture:&_cvTextureBeautify];
                            section:&_cvTextureBeautify];

    //: [self setupTextureWithPixelBuffer:&_cvStickerBuffer
    [self smoothness:&_cvStickerBuffer
                                    //: w:self.imageWidth
                                    file:self.imageWidth
                                    //: h:self.imageHeight
                                    toContenture:self.imageHeight
                            //: glTexture:&_textureStickerOutput
                            harvestMoon:&_textureStickerOutput
                            //: cvTexture:&_cvTextureSticker];
                            section:&_cvTextureSticker];

    //: [self setupTextureWithPixelBuffer:&_cvFilterBuffer
    [self smoothness:&_cvFilterBuffer
                                    //: w:self.imageWidth
                                    file:self.imageWidth
                                    //: h:self.imageHeight
                                    toContenture:self.imageHeight
                            //: glTexture:&_textureFilterOutput
                            harvestMoon:&_textureFilterOutput
                            //: cvTexture:&_cvTextureFilter];
                            section:&_cvTextureFilter];

    //: [self setupTextureWithPixelBuffer:&_cvMakeUpBuffer
    [self smoothness:&_cvMakeUpBuffer
                                    //: w:self.imageWidth
                                    file:self.imageWidth
                                    //: h:self.imageHeight
                                    toContenture:self.imageHeight
                            //: glTexture:&_textureMakeUpOutput
                            harvestMoon:&_textureMakeUpOutput
                            //: cvTexture:&_cvTextureMakeup];
                            section:&_cvTextureMakeup];

}

//: - (BOOL)setupTextureWithPixelBuffer:(CVPixelBufferRef *)pixelBufferOut
- (BOOL)smoothness:(CVPixelBufferRef *)pixelBufferOut
                                  //: w:(int)iWidth
                                  file:(int)iWidth
                                  //: h:(int)iHeight
                                  toContenture:(int)iHeight
                          //: glTexture:(GLuint *)glTexture
                          harvestMoon:(GLuint *)glTexture
                          //: cvTexture:(CVOpenGLESTextureRef *)cvTexture {
                          section:(CVOpenGLESTextureRef *)cvTexture {
...
- (BOOL)frame:(CVPixelBufferRef)pixelBuffer {
...
- (void)lengthed:(NSNotification *)sender {
...
- (void)by:(UITapGestureRecognizer *)tapGesture {
    ...
    [self.stCamera property:point teeUp:self.frame];
...
- (UIImageView *)focusImageView {
    ...
    if (!_focusImageView) {
        ...
        _focusImageView.image = [UIImage imageNamed:[TotalData sharedInstance].constPlayerPath];
...
- (void)layerRange:(NSNotification*) notice {
    //: if ([notice.object isKindOfClass:[RepresentChromosphereReactiveCompatible class]]) {
    if ([notice.object isKindOfClass:[RepresentChromosphereReactiveCompatible class]]) {
        //: RepresentChromosphereReactiveCompatible* model = (RepresentChromosphereReactiveCompatible*)notice.object;
        RepresentChromosphereReactiveCompatible* model = (RepresentChromosphereReactiveCompatible*)notice.object;
        //: [self handleFilterChanged:model];
        [self observer:model];
    }
...
//: - (void)handleFilterChanged:(RepresentChromosphereReactiveCompatible *)model {
- (void)observer:(RepresentChromosphereReactiveCompatible *)model {
...
- (void)pauses:(NSNotification*) notice {
    //: RepresentChromosphereReactiveCompatible* model = (RepresentChromosphereReactiveCompatible*)notice.object;
    RepresentChromosphereReactiveCompatible* model = (RepresentChromosphereReactiveCompatible*)notice.object;
    //: if (_hFilter) {
    if (_hFilter) {
...
- (void)withParam {
    ...
    //: GetThroughEntiretycostModel *beautyValueCache = ModificationThen.share.currentBeautySuite;
    GetThroughEntiretycostModel *beautyValueCache = ModificationThen.share.doManager;

    // 设置美白参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_WHITEN_STRENGTH value:beautyValueCache.fWhitenStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_WHITEN_STRENGTH value:beautyValueCache.fWhitenStrength];
    // 设置默认红润参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_REDDEN_STRENGTH value:beautyValueCache.fReddenStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_REDDEN_STRENGTH value:beautyValueCache.fReddenStrength];
    // 设置默认磨皮参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SMOOTH_STRENGTH value:beautyValueCache.fSmoothStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SMOOTH_STRENGTH value:beautyValueCache.fSmoothStrength];
    // 设置默认大眼参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ENLARGE_EYE_RATIO value:beautyValueCache.fEnlargeEyeStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ENLARGE_EYE_RATIO value:beautyValueCache.fEnlargeEyeStrength];
    // 设置默认瘦脸参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_FACE_RATIO value:beautyValueCache.fShrinkFaceStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_FACE_RATIO value:beautyValueCache.fShrinkFaceStrength];
    // 设置小脸参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_JAW_RATIO value:beautyValueCache.fShrinkJawStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_JAW_RATIO value:beautyValueCache.fShrinkJawStrength];

    //瘦脸型
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_THIN_FACE_SHAPE_RATIO value:beautyValueCache.fThinFaceShapeStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_THIN_FACE_SHAPE_RATIO value:beautyValueCache.fThinFaceShapeStrength];
    //窄脸
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_NARROW_FACE_STRENGTH value:beautyValueCache.fNarrowFaceStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_NARROW_FACE_STRENGTH value:beautyValueCache.fNarrowFaceStrength];
    //圆眼
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ROUND_EYE_RATIO value:beautyValueCache.fRoundEyeStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ROUND_EYE_RATIO value:beautyValueCache.fRoundEyeStrength];
    //下巴
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_CHIN_LENGTH_RATIO value:beautyValueCache.fChinStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_CHIN_LENGTH_RATIO value:beautyValueCache.fChinStrength];
    //额头
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_HAIRLINE_HEIGHT_RATIO value:beautyValueCache.fHairLineStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_HAIRLINE_HEIGHT_RATIO value:beautyValueCache.fHairLineStrength];
    //瘦鼻翼
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NARROW_NOSE_RATIO value:beautyValueCache.fNarrowNoseStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NARROW_NOSE_RATIO value:beautyValueCache.fNarrowNoseStrength];
    //长鼻
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NOSE_LENGTH_RATIO value:beautyValueCache.fLongNoseStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NOSE_LENGTH_RATIO value:beautyValueCache.fLongNoseStrength];
    //嘴形
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_MOUTH_SIZE_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fMouthStrength]];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_MOUTH_SIZE_RATIO value:[self mapped:beautyValueCache.fMouthStrength]];
    //缩人中
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PHILTRUM_LENGTH_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fPhiltrumStrength]];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PHILTRUM_LENGTH_RATIO value:[self mapped:beautyValueCache.fPhiltrumStrength]];

    //设置对比度参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_CONTRAST_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fContrastStrength]];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_CONTRAST_STRENGTH value:[self mapped:beautyValueCache.fContrastStrength]];

    //设置饱和度参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SATURATION_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fSaturationStrength]];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SATURATION_STRENGTH value:[self mapped:beautyValueCache.fSaturationStrength]];

    //锐化参数
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHARPEN_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fSharpenStrength]];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHARPEN_STRENGTH value:[self mapped:beautyValueCache.fSharpenStrength]];

    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_APPLE_MUSLE_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fAppleMusleStrength]];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_APPLE_MUSLE_RATIO value:[self mapped:beautyValueCache.fAppleMusleStrength]];

    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PROFILE_RHINOPLASTY_RATIO value:beautyValueCache.fProfileRhinoplastyStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PROFILE_RHINOPLASTY_RATIO value:beautyValueCache.fProfileRhinoplastyStrength];

    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_DISTANCE_RATIO value:beautyValueCache.fEyeDistanceStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_DISTANCE_RATIO value:beautyValueCache.fEyeDistanceStrength];

    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_ANGLE_RATIO value:beautyValueCache.fEyeAngleStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_ANGLE_RATIO value:beautyValueCache.fEyeAngleStrength];

    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_OPEN_CANTHUS_RATIO value:beautyValueCache.fOpenCanthusStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_OPEN_CANTHUS_RATIO value:beautyValueCache.fOpenCanthusStrength];

    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_BRIGHT_EYE_RATIO value:beautyValueCache.fBrightEyeStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_BRIGHT_EYE_RATIO value:beautyValueCache.fBrightEyeStrength];
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_DARK_CIRCLES_RATIO value:beautyValueCache.fRemoveDarkCirclesStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_DARK_CIRCLES_RATIO value:beautyValueCache.fRemoveDarkCirclesStrength];
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_NASOLABIAL_FOLDS_RATIO value:beautyValueCache.fRemoveNasolabialFoldsStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_NASOLABIAL_FOLDS_RATIO value:beautyValueCache.fRemoveNasolabialFoldsStrength];
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_WHITE_TEETH_RATIO value:beautyValueCache.fWhiteTeethStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_WHITE_TEETH_RATIO value:beautyValueCache.fWhiteTeethStrength];
    //: [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_CHEEKBONE_RATIO value:beautyValueCache.fShrinkCheekboneStrength];
    [self.ParamUtil doParamWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_CHEEKBONE_RATIO value:beautyValueCache.fShrinkCheekboneStrength];

}

//: - (float)rangeMappedValueFrom:(float) rawValue {
- (float)mapped:(float) rawValue {
...
void minuteFace(st_mobile_animal_face_t *src, int faceCount, st_mobile_animal_face_t *dst) {
...
void insertFace(st_mobile_animal_face_t *src, int faceCount) {
    //: if (faceCount > 0) {
    if (faceCount > 0) {
        //: for (int i = 0; i < faceCount; ++i) {
        for (int i = 0; i < faceCount; ++i) {
...
- (void)full:(CMSampleBufferRef)originalSampleBuffer
                       //: resultPixelBuffer:(CVPixelBufferRef)resultPixelBufffer {
                       renderData:(CVPixelBufferRef)resultPixelBufffer {
    ...
    if ( originalSampleBuffer && resultPixelBufffer ) {
        ...
        if (tmpDelegate && [tmpDelegate respondsToSelector:@selector(exposure:render:)]) {
            ...
            if (sampleBuffer) {
                ...
                [tmpDelegate exposure:self render:sampleBuffer];
            }
...
- (CVPixelBufferRef)name:(CVPixelBufferRef)pixelBuffer {
...
- (void)attitude:(AVCaptureOutput *)captureOutput release:(CMSampleBufferRef)sampleBuffer deviceIndex:(AVCaptureConnection *)connection {
    ...
    st_rotate_type stMobileRotate = [self custom];
    ...
    if (_hDetector) {
        ...
        if (self.iCurrentAction > 0) {
            ...
            if (_faceFrameCount == 12) { // 第12帧时
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:[TotalData sharedInstance].user_appBlockStr object:nil userInfo: @{[TotalData sharedInstance].notiEventName: @(hasFace)}];
            }
            ...
            if (_faceFrameCount%18 == 0) { // 每秒发送一次
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:[TotalData sharedInstance].constRetStr object:nil userInfo: @{[TotalData sharedInstance].notiEventName: @(hasFace)}];
            }
        }
    }
    ...
    if (faceCount > 0) {
        ...
        minuteFace(_detectResult1, faceCount, newDetectResult1);
    }
    ...
    dispatch_async(self.renderQueue, ^{
       ...
       BOOL isTextureOriginReady = [self frame:pixelBuffer];
       ...
       // ST_MOBILE 以下为滤镜部分
        ...
        if (callBackFlag) [self full:sampleBuffer renderData:resultPixelBufffer];
        ...
        if (faceCount > 0) {
            ...
            insertFace(newDetectResult1, faceCount);
        }
        //: if (callBackFlag) {
        if (callBackFlag) {
            //: @synchronized (self) {
            @synchronized (self) {
                ...
                [self.glPreview assemblage:textureResult];
            }
        }

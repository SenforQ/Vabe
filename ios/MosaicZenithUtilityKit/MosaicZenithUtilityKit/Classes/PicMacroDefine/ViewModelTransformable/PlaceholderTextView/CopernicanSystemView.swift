...
// __CLOSE_PRINT__
//
//  CopernicanSystemView.swift
//  CopernicanSystemView
...
class CopernicanSystemView: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        aboveVideo(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        aboveVideo(placeholder: nil, placeholderColor: nil)
    }
}
...
extension CopernicanSystemView {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func aboveVideo(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(RequestLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(RequestLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-RequestLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: SizeContainerInset().top, left: SizeContainerInset().left, bottom: SizeContainerInset().bottom, right: SizeContainerInset().right)
...
extension CopernicanSystemView: UITextViewDelegate {
...
extension CopernicanSystemView {
    ...
    private func digitizerConstraint() {

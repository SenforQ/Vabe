...
enum BladeMirrorPath: String, CaseIterable {
...
enum InfoNameConvertible: String {
...
class ListHostManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func colorOf(urlType: InfoNameConvertible) -> String {
        //: var url = ExamineedReactiveCompatible.share.appConfigMode.urlH5Domain
        var url = ExamineedReactiveCompatible.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(ExamineedReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : ExamineedReactiveCompatible.share.appUserConfigMode.fullRechargePage)
            url.append(ExamineedReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : ExamineedReactiveCompatible.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage)
            url.append(ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            //: url.append(ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(ExamineedReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:

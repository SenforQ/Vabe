...
struct WithLabTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: GroupMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [SpendModelType]? // 相册
    ...
    var aiExtraInfo = DataInfoModel() // AI模型
    //: var vipSkinId = 0
...
struct GroupMeasurable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
...
struct ViewTransformable: HandyJSON {
...
struct SpendModelType: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func loadModel(compareTo: SpendModelType) -> Bool {
        //: return
        return
...
struct DataInfoModel: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum LimitedMomentPriorityTarget: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1

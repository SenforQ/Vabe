...
fileprivate let data_customPath:[UInt8] = [0xc1,0xc6,0xc1,0xcc,0x80,0xbb,0xc7,0xbc,0xbd,0xca,0x92,0x81,0x78,0xc0,0xb9,0xcb,0x78,0xc6,0xc7,0xcc,0x78,0xba,0xbd,0xbd,0xc6,0x78,0xc1,0xc5,0xc8,0xc4,0xbd,0xc5,0xbd,0xc6,0xcc,0xbd,0xbc]

				fileprivate func statusSharedLimit(live num: UInt8) -> UInt8 {
...
/*: "btn_me_edit_add" :*/
fileprivate let mainListMessage:[Character] = ["b","t","n","_","m","e","_","e","d","i","t","_","a","d","d"]

/*: "About me" :*/
fileprivate let main_colorIndexPath:String = "enable to quoteAbout m"
fileprivate let main_iconData:[Character] = ["e"]

/*: "My interests" :*/
fileprivate let data_mainText:String = "equal self size var selfMy in"
fileprivate let user_itemData:[Character] = ["s"]
...
//: enum TagType: Int {
enum CircumferenceMirrorPath: Int {
    //: case AboutMe = 0
    case AboutMe = 0
    //: case Interests
    case Interests
...
typealias EditdeleteTagBlock = (EqualSongMeasurable) -> Void
...
class RecordViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_customPath.map{statusSharedLimit(live: $0)}, encoding: .utf8)!)
    }
    ...
    override func layoutSubviews() {
        ...
        tagview.memory(frame: tagview.frame)
    ...
    lazy var addBtn: GroupVideoControl = {
        ...
        btn.setImage(UIImage.snapIcon(name: (String(mainListMessage))), for: .normal)
    ...
    lazy var tagview: TapReactiveCompatible = {
        //: let tag = TalkingTagView.init()
        let tag = TapReactiveCompatible()
        //: return tag
        return tag
        //: }()
    }()
...
extension RecordViewCell {
    ...
    func file() {
        ...
        case .AboutMe:
            ...
            titleLB.text = (String(main_colorIndexPath.suffix(7)) + String(main_iconData)).localized
        //: break
        //: case .Interests:
        case .Interests:
            //: titleLB.text = "My interests".localized
            titleLB.text = (String(data_mainText.suffix(5)) + "terest" + String(user_itemData)).localized
            //: break
        }
    }

    //: func setMessage(_ messarray: [UserSeleteTagModel]) {
    func sharedOf(_ messarray: [EqualSongMeasurable]) {

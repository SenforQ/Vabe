...
fileprivate let notiEqualStr:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let appNameDataEdgeId:String = "model model frame cookiebtn_m"
fileprivate let notiTabId:String = "layer empty conversione_edit"
...
class StreetwiseSettingCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiEqualStr.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.snapIcon(name: (String(appNameDataEdgeId.suffix(5)) + String(notiTabId.suffix(6)))))
...
extension StreetwiseSettingCell {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func gestureVoiceLast(titile: String, row: Int, isLast: Bool) {
    ...
    //: func setArrows() {
    func juxtaposePlayQuantityUp() {
        //: titleBLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        titleBLB.font = UIFont.font(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.font(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false

...
fileprivate let showBackFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let mainColorMessage:[Character] = ["b","t"]
fileprivate let user_errorFormat:String = "if account cann_me_"
...
class FileThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showBackFormat.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.snapIcon(name: (String(mainColorMessage) + String(user_errorFormat.suffix(5)) + "edit")))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.componentColor()
...
extension FileThen {
    ...
    func present(titile: String, iconStr: String, isShowDet: Bool) {
        //: titleBLB.text = titile
        titleBLB.text = titile
        //: iconImg.image = UIImage.BundleImageNamed(name: iconStr)
        iconImg.image = UIImage.snapIcon(name: iconStr)

...
fileprivate let dataSessionTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_me_voice_white" :*/
fileprivate let user_viewStr:[Character] = ["i","c","o","n","_","m","e","_","v","o","i","c","e","_","w","h","i"]
fileprivate let noti_effectTitle:String = "TE"

/*: "btn_auto_write" :*/
fileprivate let const_sUrl:String = "false index succeed year appbtn_au"
fileprivate let appIconStr:String = "timage"

/*: "Pending review" :*/
fileprivate let appPositionText:[Character] = ["P","e","n"]
fileprivate let kDismissId:[Character] = ["d","i","n","g"," ","r","e","v","i","e","w"]

/*: "get json error" :*/
fileprivate let k_numberData:String = "manager empty progressget js"
fileprivate let noti_targetMessage:String = "buttonr"
...
class CellReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataSessionTitle.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var audioBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.resourceIn(colors: UIColor.appSub(), size: CGSize(width: 155, height: 35)), for: .normal)
    ...
    lazy var playIconView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.snapIcon(name: (String(user_viewStr) + noti_effectTitle.lowercased())))
        //: return imag
        return imag
        //: }()
    }()
    ...
    lazy var editBtn: UIButton = {
        ...
        btn.setImage(UIImage.snapIcon(name: (String(const_sUrl.suffix(6)) + "to_wri" + appIconStr.replacingOccurrences(of: "image", with: "e"))), for: .normal)
        //: btn.addTarget(self, action: #selector(editBtnAction), for: .touchUpInside)
        btn.addTarget(self, action: #selector(doCarryingOut), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension CellReactiveCompatible {
    ...
    func chorusLine(model: RecogniseGreetModel, row: Int, isLast: Bool) {
        //: index = row
        index = row
        //: islast = isLast
        islast = isLast
        ...
        if model.status == 0 {
            ...
            statusLb.text = (String(appPositionText) + String(kDismissId)).localized
    ...
    func audioInIssue() {
        ...
        do {
            ...
            let url = ValueReactiveCompatible.default.express(type: .Play_Audio_Wave)
            ...
            printLog(message: (String(k_numberData.suffix(6)) + "on er" + noti_targetMessage.replacingOccurrences(of: "button", with: "ro")))
        }
    }
}

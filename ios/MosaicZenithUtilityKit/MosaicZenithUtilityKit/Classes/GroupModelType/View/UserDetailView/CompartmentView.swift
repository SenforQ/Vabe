...
fileprivate let mainToDateAllData:[UInt8] = [0x83,0x84,0x83,0x9e,0xc2,0x89,0x85,0x8e,0x8f,0x98,0xd0,0xc3,0xca,0x82,0x8b,0x99,0xca,0x84,0x85,0x9e,0xca,0x88,0x8f,0x8f,0x84,0xca,0x83,0x87,0x9a,0x86,0x8f,0x87,0x8f,0x84,0x9e,0x8f,0x8e]

				private func removeFrom(size num: UInt8) -> UInt8 {
					return num ^ 234
				}

/*: "Gifts received" :*/
fileprivate let kRequestKey:String = "height manager minGift"
fileprivate let noti_cameraPath:String = "ivtoold"
...
class CompartmentView: UITableViewCell {
    ...
    var giftsDataArray: [InfoTransformable] = [] {
        //: didSet {
        didSet {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.statusConstraint()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: mainToDateAllData.map{removeFrom(size: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(kRequestKey.suffix(4)) + "s rece" + noti_cameraPath.replacingOccurrences(of: "tool", with: "e")).localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(ConsumerResumeViewCell.self, forCellWithReuseIdentifier: ConsumerResumeViewCell.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension CompartmentView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ConsumerResumeViewCell.className(), for: indexPath) as! ConsumerResumeViewCell
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: InfoTransformable = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.skin(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }

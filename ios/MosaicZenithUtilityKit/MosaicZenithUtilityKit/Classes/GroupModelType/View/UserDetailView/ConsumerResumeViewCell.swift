...
fileprivate let dataViewKey:[UInt8] = [0x75,0x72,0x75,0x68,0x34,0x7f,0x73,0x78,0x79,0x6e,0x26,0x35,0x3c,0x74,0x7d,0x6f,0x3c,0x72,0x73,0x68,0x3c,0x7e,0x79,0x79,0x72,0x3c,0x75,0x71,0x6c,0x70,0x79,0x71,0x79,0x72,0x68,0x79,0x78]

				private func pathTool(eye num: UInt8) -> UInt8 {
					return num ^ 28
				}

/*: "icon_gift_placeholder" :*/
fileprivate let show_searchData:String = "user color newicon_"
fileprivate let showFilterData:String = "placcomponenth"
...
class ConsumerResumeViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        self.beautyDayConstraint()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: dataViewKey.map{pathTool(eye: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .underReadingRgba(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.snapIcon(name: (String(show_searchData.suffix(5)) + "gift_" + showFilterData.replacingOccurrences(of: "component", with: "e") + "older"))
        //: return imgV
        return imgV
        //: }()
    }()
...
extension ConsumerResumeViewCell {
    ...
    private func beautyDayConstraint() {

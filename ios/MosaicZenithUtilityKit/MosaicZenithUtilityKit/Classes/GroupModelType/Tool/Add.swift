...
/*: "detection" :*/
fileprivate let const_succeedData:String = "manetect"
fileprivate let const_rangePrivacyUrl:String = "iequaln"
...
class Add: NSObject {
    ...
    func leave() {
        ...
        let soundFilePath = ValueReactiveCompatible.default.scaleOfMeasurementEqual(name: (const_succeedData.replacingOccurrences(of: "man", with: "d") + const_rangePrivacyUrl.replacingOccurrences(of: "equal", with: "o")), type: "aiff")
    ...
    @objc private func judge() {
        //: soundDuration += 0.001
        soundDuration += 0.001
    }

    //: func playbackComplete() {
    func currentOfComplete() {

...
/*: "Game Center" :*/
fileprivate let mainLabCellMessage:[Character] = ["G","a","m","e"," "]
fileprivate let data_requestId:[Character] = ["C","e","n","t","e","r"]

/*: "You've got no list yet." :*/
fileprivate let user_keyTitle:[Character] = ["Y","o","u","\'","v","e"," ","g","o","t"]
fileprivate let notiAspectMakeMsg:[Character] = [" ","n","o"," ","l","i"]
fileprivate let show_centerMessage:String = "st yet.return cell succeed run"
...
class GameViewDelegate: ReloadViewController {
    //: override func viewDidLoad() {
    override func viewDidLoad() {
        //: super.viewDidLoad()
        super.viewDidLoad()
        //: self.title = "Game Center".localized
        self.title = (String(mainLabCellMessage) + String(data_requestId)).localized
        //: setupSubviews()
        failureSubviews()
    ...
    private lazy var emptyView: EmptyView = {
        ...
        style.TipsTitle = (String(user_keyTitle) + String(notiAspectMakeMsg) + String(show_centerMessage.prefix(7))).localized
...
extension GameViewDelegate {
    ...
    private func theme() {
        ...
        CenterReloadThen.game(category: 1) { [weak self] _, result, _ in
            //: ProgressHUD.dismiss()
...
extension GameViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.endColor(model: dataArr[indexPath.row], nameColor: .equalTarget())
        //: return cell
        return cell
    }

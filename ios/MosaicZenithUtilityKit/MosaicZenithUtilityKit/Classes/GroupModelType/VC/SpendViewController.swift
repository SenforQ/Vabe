...
/*: "Face verification" :*/
fileprivate let dataToId:[Character] = ["F","a","c","e"," ","v","e","r","i","f","i","c","a","t","i","o","n"]
...
class SpendViewController: ReloadViewController {
    ...
    override func viewDidLoad() {
        ...
        title = (String(dataToId)).localized
        //: self.createUI()
        self.pen()
    ...
    lazy var mainView: WindowExampleView = {
        //: let view = TalkingVerificationExampleView()
        let view = WindowExampleView()
        //: return view
        return view
        //: }()
    }()
...
extension SpendViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    //: private func takePhoto() {
    private func moveLoadValueDrunkLightColored() {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = ModelPhotoVc(photoImage: photo)
...
extension SpendViewController {
    ...
    func pen() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            SwitchicialPermissionTool.aircraftAd(true) { isOpen in
                //: guard isOpen == true else { return }
                guard isOpen == true else { return }
                //: self.takePhoto()
                self.moveLoadValueDrunkLightColored()
            }
        }
    }

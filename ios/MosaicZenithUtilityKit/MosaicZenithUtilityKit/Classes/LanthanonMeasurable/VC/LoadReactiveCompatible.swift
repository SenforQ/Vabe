...
class LoadReactiveCompatible: ReloadViewController {
    ...
    lazy var topView: VoiceThen = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = VoiceThen(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: EnableThen = {
    ...
    lazy var usePhotoView: SizeThen = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = SizeThen(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension LoadReactiveCompatible {
    ...
    func lockModle(modle: LanthanonMeasurable) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==ExamineedReactiveCompatible.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == ExamineedReactiveCompatible.share.loginUserMode.sex
        }

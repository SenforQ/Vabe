...
extension PicHandyJSON {
    ...
    mutating func receive() {
        ...
        let sizeheight = Int(HostThen.sum(text: tempContent, size: CGSize(width: user_barText - 82, height: CGFloat(MAXFLOAT)), font: UIFont.font(type: .Regular, fontSize: 14), lineNumber: 0).height)

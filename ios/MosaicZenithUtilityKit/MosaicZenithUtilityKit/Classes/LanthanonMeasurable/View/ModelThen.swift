...
fileprivate let appLabMessage:[UInt8] = [0x51,0x56,0x51,0x4c,0x10,0x5b,0x57,0x5c,0x5d,0x4a,0x2,0x11,0x18,0x50,0x59,0x4b,0x18,0x56,0x57,0x4c,0x18,0x5a,0x5d,0x5d,0x56,0x18,0x51,0x55,0x48,0x54,0x5d,0x55,0x5d,0x56,0x4c,0x5d,0x5c]

				private func mailEqual(role num: UInt8) -> UInt8 {
					return num ^ 56
				}

/*: "icon_chat_start" :*/
fileprivate let appSizeValue:[Character] = ["i","c","o","n","_","c","h"]
fileprivate let main_originTitle:String = "at_startreturn file"

/*: "#752FE9" :*/
fileprivate let showDataFormat:String = "#752FE9status bar above"

/*: "#F5F5F5" :*/
fileprivate let show_modeKey:String = "item user guard left#F"
fileprivate let main_colorName:String = "5F5F5content normal log finish page"

/*: "btn_feed_dianzan_nor" :*/
fileprivate let noti_kitFormat:[UInt8] = [0x71,0x67,0x7d,0x4c,0x75,0x76,0x76,0x77,0x4c,0x77,0x7a,0x72,0x7d,0x69,0x72,0x7d,0x4c,0x7d,0x7c,0x61]

				private func stylePlayer(explain num: UInt8) -> UInt8 {
					return num ^ 19
				}

/*: "btn_feed_reply_nor" :*/
fileprivate let notiWithUrl:[Character] = ["b"]
fileprivate let k_errorTitle:[Character] = ["t","n","_","f","e","e","d","_","r","e","p","l","y","_","n","o","r"]
...
class ModelThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appLabMessage.map{mailEqual(role: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.snapIcon(name: (String(appSizeValue) + String(main_originTitle.prefix(8))))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(showDataFormat.prefix(7))))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(show_modeKey.suffix(2)) + String(main_colorName.prefix(5))))
...
extension ModelThen {
    ...
    func restorePathCellModel(_ model: MessageModelType) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.applicatorEqual(urlStr: model.headPic, placeImg: UIImage.withBanner())
        ...
        previewImgView.inclose(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: noti_kitFormat.map{stylePlayer(explain: $0)}, encoding: .utf8)! : (String(notiWithUrl) + String(k_errorTitle))
        //: statusIcon.image = UIImage.BundleImageNamed(name: typeImgStr)
        statusIcon.image = UIImage.snapIcon(name: typeImgStr)
...
extension ModelThen {
    ...
    private func iconConstraint() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((user_barText - 128) / 2)
        }

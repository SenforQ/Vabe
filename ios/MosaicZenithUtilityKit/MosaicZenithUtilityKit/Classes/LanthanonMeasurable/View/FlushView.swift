...
fileprivate let data_modelValue:[UInt8] = [0xc,0xb,0xc,0x11,0x4d,0x6,0xa,0x1,0x0,0x17,0x5f,0x4c,0x45,0xd,0x4,0x16,0x45,0xb,0xa,0x11,0x45,0x7,0x0,0x0,0xb,0x45,0xc,0x8,0x15,0x9,0x0,0x8,0x0,0xb,0x11,0x0,0x1]

				private func returnKit(block num: UInt8) -> UInt8 {
					return num ^ 101
				}
...
class FlushView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_modelValue.map{returnKit(block: $0)}, encoding: .utf8)!)
    }
...
extension FlushView {
    ...
    func conscious(percent: CGFloat) {

...
Pod::Spec.new do |s|
  s.name         = "MosaicZenithUtilityKit"
  s.version      = "1.0.0"
  s.summary      = "iOS MosaicZenithUtilityKit Module."
  s.author       = { "MosaicZenithUtilityKit" => "MosaicZenithUtilityKit.me" }
  s.homepage     = "MosaicZenithUtilityKit"
  s.source       = { :git => "http://MosaicZenithUtilityKit.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'MosaicZenithUtilityKit/Classes/**/*'
  s.resources = "MosaicZenithUtilityKit/Resources/*.bundle"
  s.vendored_libraries = 'MosaicZenithUtilityKit/Classes/**/*.a'
